...
Hexadecimal [16-Bits]
   ...
   6ED5                      20 olas2::
   6ED5 3E 4B         [ 7]   21     ld a, #0x4B
   6ED7                      22 olas1:
   6ED7 F5            [11]   23     push af
                             24     
   6ED8 11 00 C0      [10]   25     ld      de, #0xC000        ;;Puntero a la posición en pantalla (COOO sería el inicio de la pantalla)
   6EDB 4F            [ 4]   26     ld      c,  a              ;;Coordenada X 
   6EDC 06 95         [ 7]   27     ld      b,  #0x95         ;;Coordenada Y 
   6EDE CD 6C B0      [17]   28     call cpct_getScreenPtr_asm  ;;Función que calcula la dirección de memoria de video con esos parámetros
                             29 
   6EE1 EB            [ 4]   30     ex      de, hl             ;;Intercambia los 2 valores (supongo que la fucion de dibujo lo usará)
   6EE2 3E 0E         [ 7]   31     ld      a,  #0x0E          ;;Color (en la posición de la entidad)
   6EE4 0E 01         [ 7]   32     ld      c,  #1        ;;Ancho (en la posición de la entidad)
   6EE6 06 04         [ 7]   33     ld      b,  #4         ;;Alto (en la posición de la entidad)
   6EE8 CD C1 AF      [17]   34     call cpct_drawSolidBox_asm  ;;Función de dibujado de cpc
                             35 
   6EEB F1            [10]   36     pop af
   6EEC 3D            [ 4]   37     dec a
   6EED 28 11         [12]   38     jr z, final
   6EEF 3D            [ 4]   39     dec a
   6EF0 28 0E         [12]   40     jr z, final
   6EF2 3D            [ 4]   41     dec a
   6EF3 28 0B         [12]   42     jr z, final
   6EF5 3D            [ 4]   43     dec a
   6EF6 28 08         [12]   44     jr z, final
   6EF8 3D            [ 4]   45     dec a
   6EF9 28 05         [12]   46     jr z, final
   6EFB 3D            [ 4]   47     dec a
   6EFC 28 02         [12]   48     jr z, final
   6EFE 20 D7         [12]   49     jr nz, olas1
   6F00                      50 final:
                             51 
   6F00 3E 4A         [ 7]   52 ld a, #0x4A
   6F02                      53 olas22:
   6F02 F5            [11]   54     push af
                             55     
   6F03 11 00 C0      [10]   56     ld      de, #0xC000        ;;Puntero a la posición en pantalla (COOO sería el inicio de la pantalla)
   6F06 4F            [ 4]   57     ld      c,  a              ;;Coordenada X 
   6F07 06 96         [ 7]   58     ld      b,  #0x96         ;;Coordenada Y 
   6F09 CD 6C B0      [17]   59     call cpct_getScreenPtr_asm  ;;Función que calcula la dirección de memoria de video con esos parámetros
                             60 
   6F0C EB            [ 4]   61     ex      de, hl             ;;Intercambia los 2 valores (supongo que la fucion de dibujo lo usará)
   6F0D 3E 0E         [ 7]   62     ld      a,  #0x0E          ;;Color (en la posición de la entidad)
   6F0F 0E 01         [ 7]   63     ld      c,  #1        ;;Ancho (en la posición de la entidad)
   6F11 06 04         [ 7]   64     ld      b,  #4         ;;Alto (en la posición de la entidad)
   6F13 CD C1 AF      [17]   65     call cpct_drawSolidBox_asm  ;;Función de dibujado de cpc
                             66 
   6F16 F1            [10]   67     pop af
   6F17 3D            [ 4]   68     dec a
   6F18 28 11         [12]   69     jr z, final2
   6F1A 3D            [ 4]   70     dec a
   6F1B 28 0E         [12]   71     jr z, final2
   6F1D 3D            [ 4]   72     dec a
...
Hexadecimal [16-Bits]
   ...
   6F1E 28 0B         [12]   73     jr z, final2
   6F20 3D            [ 4]   74     dec a
   6F21 28 08         [12]   75     jr z, final2
   6F23 3D            [ 4]   76     dec a
   6F24 28 05         [12]   77     jr z, final2
   6F26 3D            [ 4]   78     dec a
   6F27 28 02         [12]   79     jr z, final2
   6F29 20 D7         [12]   80     jr nz, olas22
   6F2B                      81 final2:
                             82 
   6F2B 3E 49         [ 7]   83 ld a, #0x49
   6F2D                      84 olas3:
   6F2D F5            [11]   85     push af
                             86     
   6F2E 11 00 C0      [10]   87     ld      de, #0xC000        ;;Puntero a la posición en pantalla (COOO sería el inicio de la pantalla)
   6F31 4F            [ 4]   88     ld      c,  a              ;;Coordenada X 
   6F32 06 97         [ 7]   89     ld      b,  #0x97         ;;Coordenada Y 
   6F34 CD 6C B0      [17]   90     call cpct_getScreenPtr_asm  ;;Función que calcula la dirección de memoria de video con esos parámetros
                             91 
   6F37 EB            [ 4]   92     ex      de, hl             ;;Intercambia los 2 valores (supongo que la fucion de dibujo lo usará)
   6F38 3E 0E         [ 7]   93     ld      a,  #0x0E          ;;Color (en la posición de la entidad)
   6F3A 0E 01         [ 7]   94     ld      c,  #1        ;;Ancho (en la posición de la entidad)
   6F3C 06 04         [ 7]   95     ld      b,  #4         ;;Alto (en la posición de la entidad)
   6F3E CD C1 AF      [17]   96     call cpct_drawSolidBox_asm  ;;Función de dibujado de cpc
                             97 
   6F41 F1            [10]   98     pop af
   6F42 3D            [ 4]   99     dec a
   6F43 28 11         [12]  100     jr z, final3
   6F45 3D            [ 4]  101     dec a
   6F46 28 0E         [12]  102     jr z, final3
   6F48 3D            [ 4]  103     dec a
   6F49 28 0B         [12]  104     jr z, final3
   6F4B 3D            [ 4]  105      dec a
   6F4C 28 08         [12]  106     jr z, final3
   6F4E 3D            [ 4]  107     dec a
   6F4F 28 05         [12]  108     jr z, final3
   6F51 3D            [ 4]  109     dec a
   6F52 28 02         [12]  110     jr z, final3
   6F54 20 D7         [12]  111     jr nz, olas3
   6F56                     112 final3:
                            113 
   6F56 3E 48         [ 7]  114 ld a, #0x48
   6F58                     115 olas4:
   6F58 F5            [11]  116     push af
                            117     
   6F59 11 00 C0      [10]  118     ld      de, #0xC000        ;;Puntero a la posición en pantalla (COOO sería el inicio de la pantalla)
   6F5C 4F            [ 4]  119     ld      c,  a              ;;Coordenada X 
   6F5D 06 96         [ 7]  120     ld      b,  #0x96         ;;Coordenada Y 
   6F5F CD 6C B0      [17]  121     call cpct_getScreenPtr_asm  ;;Función que calcula la dirección de memoria de video con esos parámetros
                            122 
   6F62 EB            [ 4]  123     ex      de, hl             ;;Intercambia los 2 valores (supongo que la fucion de dibujo lo usará)
   6F63 3E 0E         [ 7]  124     ld      a,  #0x0E          ;;Color (en la posición de la entidad)
   6F65 0E 01         [ 7]  125     ld      c,  #1        ;;Ancho (en la posición de la entidad)
   6F67 06 04         [ 7]  126     ld      b,  #4         ;;Alto (en la posición de la entidad)
   6F69 CD C1 AF      [17]  127     call cpct_drawSolidBox_asm  ;;Función de dibujado de cpc
...
Hexadecimal [16-Bits]
                            ...
                            128 
   6F6C F1            [10]  129     pop af
   6F6D 3D            [ 4]  130     dec a
   6F6E 28 11         [12]  131     jr z, final4
   6F70 3D            [ 4]  132     dec a
   6F71 28 0E         [12]  133     jr z, final4
   6F73 3D            [ 4]  134     dec a
   6F74 28 0B         [12]  135     jr z, final4
   6F76 3D            [ 4]  136     dec a
   6F77 28 08         [12]  137     jr z, final4
   6F79 3D            [ 4]  138     dec a
   6F7A 28 05         [12]  139     jr z, final4
   6F7C 3D            [ 4]  140     dec a
   6F7D 28 02         [12]  141     jr z, final4
   6F7F 20 D7         [12]  142     jr nz, olas4
   6F81                     143 final4:
                            144 
                            145 
                            146 
                            147 ;;AQUI EMPIEZA LAS OLAS EN LA OTRA DIRECCION
   6F81 3E 4C         [ 7]  148 ld a, #0x4C
   6F83                     149 olas7:
   6F83 F5            [11]  150     push af
                            151     
   6F84 11 00 C0      [10]  152     ld      de, #0xC000        ;;Puntero a la posición en pantalla (COOO sería el inicio de la pantalla)
   6F87 4F            [ 4]  153     ld      c,  a              ;;Coordenada X 
   6F88 06 95         [ 7]  154     ld      b,  #0x95         ;;Coordenada Y 
   6F8A CD 6C B0      [17]  155     call cpct_getScreenPtr_asm  ;;Función que calcula la dirección de memoria de video con esos parámetros
                            156 
   6F8D EB            [ 4]  157     ex      de, hl             ;;Intercambia los 2 valores (supongo que la fucion de dibujo lo usará)
   6F8E 3E 0E         [ 7]  158     ld      a,  #0x0E          ;;Color (en la posición de la entidad)
   6F90 0E 01         [ 7]  159     ld      c,  #1        ;;Ancho (en la posición de la entidad)
   6F92 06 04         [ 7]  160     ld      b,  #4         ;;Alto (en la posición de la entidad)
   6F94 CD C1 AF      [17]  161     call cpct_drawSolidBox_asm  ;;Función de dibujado de cpc
                            162 
   6F97 F1            [10]  163     pop af
   6F98 3D            [ 4]  164     dec a
   6F99 28 11         [12]  165     jr z, final7
   6F9B 3D            [ 4]  166     dec a
   6F9C 28 0E         [12]  167     jr z, final7
   6F9E 3D            [ 4]  168     dec a
   6F9F 28 0B         [12]  169     jr z, final7
   6FA1 3D            [ 4]  170     dec a
   6FA2 28 08         [12]  171     jr z, final7
   6FA4 3D            [ 4]  172     dec a
   6FA5 28 05         [12]  173     jr z, final7
   6FA7 3D            [ 4]  174     dec a
   6FA8 28 02         [12]  175     jr z, final7
   6FAA 20 D7         [12]  176     jr nz, olas7
   6FAC                     177 final7:
                            178 
   6FAC 3E 4D         [ 7]  179 ld a, #0x4D
   6FAE                     180 olas8:
   6FAE F5            [11]  181     push af
                            182     
...
Hexadecimal [16-Bits]
   ...
   6FAF 11 00 C0      [10]  183     ld      de, #0xC000        ;;Puntero a la posición en pantalla (COOO sería el inicio de la pantalla)
   6FB2 4F            [ 4]  184     ld      c,  a              ;;Coordenada X 
   6FB3 06 96         [ 7]  185     ld      b,  #0x96         ;;Coordenada Y 
   6FB5 CD 6C B0      [17]  186     call cpct_getScreenPtr_asm  ;;Función que calcula la dirección de memoria de video con esos parámetros
                            187 
   6FB8 EB            [ 4]  188     ex      de, hl             ;;Intercambia los 2 valores (supongo que la fucion de dibujo lo usará)
   6FB9 3E 0E         [ 7]  189     ld      a,  #0x0E          ;;Color (en la posición de la entidad)
   6FBB 0E 01         [ 7]  190     ld      c,  #1        ;;Ancho (en la posición de la entidad)
   6FBD 06 04         [ 7]  191     ld      b,  #4         ;;Alto (en la posición de la entidad)
   6FBF CD C1 AF      [17]  192     call cpct_drawSolidBox_asm  ;;Función de dibujado de cpc
                            193 
   6FC2 F1            [10]  194     pop af
   6FC3 3D            [ 4]  195     dec a
   6FC4 28 11         [12]  196     jr z, final8
   6FC6 3D            [ 4]  197     dec a
   6FC7 28 0E         [12]  198     jr z, final8
   6FC9 3D            [ 4]  199     dec a
   6FCA 28 0B         [12]  200     jr z, final8
   6FCC 3D            [ 4]  201     dec a
   6FCD 28 08         [12]  202     jr z, final8
   6FCF 3D            [ 4]  203     dec a
   6FD0 28 05         [12]  204     jr z, final8
   6FD2 3D            [ 4]  205     dec a
   6FD3 28 02         [12]  206     jr z, final8
   6FD5 20 D7         [12]  207     jr nz, olas8
   6FD7                     208 final8:
                            209 
   6FD7 3E 4E         [ 7]  210 ld a, #0x4E
   6FD9                     211 olas9:
   6FD9 F5            [11]  212     push af
                            213     
   6FDA 11 00 C0      [10]  214     ld      de, #0xC000        ;;Puntero a la posición en pantalla (COOO sería el inicio de la pantalla)
   6FDD 4F            [ 4]  215     ld      c,  a              ;;Coordenada X 
   6FDE 06 97         [ 7]  216     ld      b,  #0x97         ;;Coordenada Y 
   6FE0 CD 6C B0      [17]  217     call cpct_getScreenPtr_asm  ;;Función que calcula la dirección de memoria de video con esos parámetros
                            218 
   6FE3 EB            [ 4]  219     ex      de, hl             ;;Intercambia los 2 valores (supongo que la fucion de dibujo lo usará)
   6FE4 3E 0E         [ 7]  220     ld      a,  #0x0E          ;;Color (en la posición de la entidad)
   6FE6 0E 01         [ 7]  221     ld      c,  #1        ;;Ancho (en la posición de la entidad)
   6FE8 06 04         [ 7]  222     ld      b,  #4         ;;Alto (en la posición de la entidad)
   6FEA CD C1 AF      [17]  223     call cpct_drawSolidBox_asm  ;;Función de dibujado de cpc
                            224 
   6FED F1            [10]  225     pop af
   6FEE 3D            [ 4]  226     dec a
   6FEF 28 11         [12]  227     jr z, final9
   6FF1 3D            [ 4]  228     dec a
   6FF2 28 0E         [12]  229     jr z, final9
   6FF4 3D            [ 4]  230     dec a
   6FF5 28 0B         [12]  231     jr z, final9
   6FF7 3D            [ 4]  232      dec a
   6FF8 28 08         [12]  233     jr z, final9
   6FFA 3D            [ 4]  234     dec a
   6FFB 28 05         [12]  235     jr z, final9
   6FFD 3D            [ 4]  236     dec a
   6FFE 28 02         [12]  237     jr z, final9
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (Zilog Z80 / Hitachi HD64180), page 59.
Hexadecimal [16-Bits]



   7000 20 D7         [12]  238     jr nz, olas9
   7002                     239 final9:
                            240 
   7002 3E 4F         [ 7]  241 ld a, #0x4F
   7004                     242 olas10:
   7004 F5            [11]  243     push af
                            244     
   7005 11 00 C0      [10]  245     ld      de, #0xC000        ;;Puntero a la posición en pantalla (COOO sería el inicio de la pantalla)
   7008 4F            [ 4]  246     ld      c,  a              ;;Coordenada X 
   7009 06 96         [ 7]  247     ld      b,  #0x96         ;;Coordenada Y 
   700B CD 6C B0      [17]  248     call cpct_getScreenPtr_asm  ;;Función que calcula la dirección de memoria de video con esos parámetros
                            249 
   700E EB            [ 4]  250     ex      de, hl             ;;Intercambia los 2 valores (supongo que la fucion de dibujo lo usará)
   700F 3E 0E         [ 7]  251     ld      a,  #0x0E          ;;Color (en la posición de la entidad)
   7011 0E 01         [ 7]  252     ld      c,  #1        ;;Ancho (en la posición de la entidad)
   7013 06 04         [ 7]  253     ld      b,  #4         ;;Alto (en la posición de la entidad)
   7015 CD C1 AF      [17]  254     call cpct_drawSolidBox_asm  ;;Función de dibujado de cpc
                            255 
   7018 F1            [10]  256     pop af
   7019 3D            [ 4]  257     dec a
   701A 28 11         [12]  258     jr z, final10
   701C 3D            [ 4]  259     dec a
   701D 28 0E         [12]  260     jr z, final10
   701F 3D            [ 4]  261     dec a
   7020 28 0B         [12]  262     jr z, final10
   7022 3D            [ 4]  263     dec a
   7023 28 08         [12]  264     jr z, final10
   7025 3D            [ 4]  265     dec a
   7026 28 05         [12]  266     jr z, final10
   7028 3D            [ 4]  267     dec a
   7029 28 02         [12]  268     jr z, final10
   702B 20 D7         [12]  269     jr nz, olas10
   702D                     270 final10:
                            271 
