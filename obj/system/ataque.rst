...
Hexadecimal [16-Bits]
                             ...
                             19 .include "system/mainJuego.h.s"
                              1 ;;This file is part of Kubso.
                              2 ;;
                              3 ;;Kubso is free software: you can redistribute it and/or modify
                              4 ;;it under the terms of the GNU General Public License as published by
...
Hexadecimal [16-Bits]
                             ...
                             20 .include "system/colisionesRapidas.h.s"
                              1 ;;This file is part of Kubso.
                              2 ;;
                              3 ;;Kubso is free software: you can redistribute it and/or modify
                              4 ;;it under the terms of the GNU General Public License as published by
...
Hexadecimal [16-Bits]
                             ...
                             24 
   7DA0 00                   25 estadoEspadaPrevio:: .db #0
                             26 
   7DA1                      27 ataqueEspada::
                             28 
   7DA1 CD DA AD      [17]   29     call  cpct_scanKeyboard_f_asm
   7DA4 21 05 80      [10]   30     ld  hl, #Key_Space
   7DA7 CD 44 AE      [17]   31     call cpct_isKeyPressed_asm
   7DAA C8            [11]   32     ret z
                             33 
   7DAB DD 21 0A 40   [14]   34     ld ix, #espadaPos
   7DAF DD 7E 05      [19]   35     ld a, entity_vy(ix)
   7DB2 3D            [ 4]   36     dec a
   7DB3 C8            [11]   37     ret z
   7DB4 3D            [ 4]   38     dec a
   7DB5 C8            [11]   39     ret z
   ...
   7DB8 3D            [ 4]   42     dec a
   7DB9 C8            [11]   43     ret z
   7DBA DD 36 05 04   [19]   44     ld entity_vy(ix), #4
                             45 
   7DBE DD 21 0A 40   [14]   46     ld  ix, #espadaPos ;;enemyPos
   7DC2 DD 7E 04      [19]   47     ld  a, entity_estado(ix)
   7DC5 3D            [ 4]   48     dec a
   7DC6 28 1A         [12]   49     jr  z,   pintarIzquierda
   7DC8                      50     pintarDerecha:
   7DC8 CD AA AA      [17]   51         call pintarEspadaDerecha
                             52 
                             53         ;;halt 
                             54         ;;halt
   7DCB CD 81 AF      [17]   55         call cpct_waitVSYNC_asm
   7DCE 76            [ 4]   56         halt 
   7DCF 76            [ 4]   57         halt
   7DD0 CD 81 AF      [17]   58         call cpct_waitVSYNC_asm
   7DD3 76            [ 4]   59         halt 
   7DD4 76            [ 4]   60         halt
   7DD5 CD 81 AF      [17]   61         call cpct_waitVSYNC_asm
                             62         ;;ld a, #20
                             63         ;;esperaEspada:
                             64         ;;halt
                             65         ;;dec a
                             66         ;;jr nz, esperaEspada
                             67 
                             68         ;;call borrarEspadaDerecha
   7DD8 DD 21 A0 7D   [14]   69         ld ix, #estadoEspadaPrevio
   7DDC DD 36 00 00   [19]   70         ld 0(ix), #0
   7DE0 18 18         [12]   71         jr espadaPintada
                             72 
   7DE2                      73     pintarIzquierda:
   7DE2 CD D6 AA      [17]   74         call pintarEspadaIzquierda
                             75 
                             76         ;;halt 
                             77         ;;halt
   7DE5 CD 81 AF      [17]   78         call cpct_waitVSYNC_asm
...
Hexadecimal [16-Bits]
   ...
   7DE8 76            [ 4]   79         halt 
   7DE9 76            [ 4]   80         halt
   7DEA CD 81 AF      [17]   81         call cpct_waitVSYNC_asm
   7DED 76            [ 4]   82         halt 
   7DEE 76            [ 4]   83         halt
   7DEF CD 81 AF      [17]   84         call cpct_waitVSYNC_asm
                             85         ;;ld a, #20
                             86         ;;esperaEspadaIzq:
                             87         ;;halt
                             88         ;;dec a
                             89         ;;jr nz, esperaEspadaIzq
                             90 
                             91         ;;call borrarEspadaIzquierda
   7DF2 DD 21 A0 7D   [14]   92         ld ix, #estadoEspadaPrevio
   7DF6 DD 36 00 01   [19]   93         ld 0(ix), #1
                             94 
                             95 
   7DFA                      96     espadaPintada:
   7DFA CD 26 53      [17]   97         call colisionRapida
                             98         ;;Comprobacion posicion del enemigo
   7DFD DD 21 0A 40   [14]   99         ld  ix, #espadaPos
   7E01 DD 7E 00      [19]  100         ld  a,  entity_x(ix)
   7E04 DD 21 1F 40   [14]  101         ld  ix, #enemyPos
   7E08 DD 46 00      [19]  102         ld  b,  entity_x(ix)
                            103 
   7E0B                     104     colisionEspadaDer:
   7E0B 3D            [ 4]  105         dec a
   7E0C 28 05         [12]  106         jr z, espadaCero
   7E0E 05            [ 4]  107         dec b
   7E0F 28 10         [12]  108         jr z, enemigoCero
   7E11 18 F8         [12]  109         jr colisionEspadaDer
   7E13                     110     espadaCero:
   7E13 05            [ 4]  111         dec b
   7E14 28 32         [12]  112         jr z, enemigoDerAsesinado
   7E16 05            [ 4]  113         dec b
   7E17 28 2F         [12]  114         jr z, enemigoDerAsesinado
   7E19 05            [ 4]  115         dec b
   7E1A 28 2C         [12]  116         jr z, enemigoDerAsesinado
   7E1C 05            [ 4]  117         dec b
   7E1D 28 29         [12]  118         jr z, enemigoDerAsesinado
   7E1F 18 03         [12]  119         jr noColisionDer
   7E21                     120     enemigoCero:
   7E21 3D            [ 4]  121         dec a
   7E22 28 24         [12]  122         jr z, enemigoDerAsesinado
                            123 
   7E24                     124     noColisionDer:
   7E24 DD 21 0A 40   [14]  125         ld  ix, #espadaPos
   7E28 DD 7E 00      [19]  126         ld  a,  entity_x(ix)
   7E2B DD 21 2D 40   [14]  127         ld  ix, #enemyIzqPos
   7E2F DD 46 00      [19]  128         ld  b,  entity_x(ix)
   7E32                     129     colisionEspadaIzq:
   7E32 05            [ 4]  130         dec b
   7E33 28 05         [12]  131         jr z, enemigoCeroI
   7E35 3D            [ 4]  132         dec a
   7E36 28 0F         [12]  133         jr z, espadaCeroI
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (Zilog Z80 / Hitachi HD64180), page 63.
Hexadecimal [16-Bits]



   7E38 18 F8         [12]  134         jr colisionEspadaIzq
   7E3A                     135     enemigoCeroI:
   7E3A 3D            [ 4]  136         dec a
   7E3B 28 37         [12]  137         jr z, enemigoIzqAsesinado
   7E3D 3D            [ 4]  138         dec a
   7E3E 28 34         [12]  139         jr z, enemigoIzqAsesinado
   7E40 3D            [ 4]  140         dec a
   7E41 28 31         [12]  141         jr z, enemigoIzqAsesinado
   7E43 3D            [ 4]  142         dec a
   7E44 28 2E         [12]  143         jr z, enemigoIzqAsesinado
   7E46 C9            [10]  144         ret
   7E47                     145     espadaCeroI:
   7E47 C9            [10]  146         ret
                            147 
                            148         ;
   7E48                     149     enemigoDerAsesinado:
                            150         
   7E48 CD BC 82      [17]  151         call borrarEnemigo1
   7E4B CD C0 AA      [17]  152         call borrarEspadaDerecha
   7E4E DD 21 1F 40   [14]  153         ld  ix, #enemyPos
   7E52 DD 36 00 48   [19]  154         ld  entity_x(ix), #72
   7E56 DD 36 04 00   [19]  155         ld  entity_estado(ix), #0
   7E5A CD F6 7E      [17]  156         call pintarEnemigo1
                            157         ;
   7E5D DD 21 18 40   [14]  158         ld  ix, #wallDPos
   7E61 DD 7E 05      [19]  159         ld  a, entity_vy(ix)
   7E64 3D            [ 4]  160         dec a
   7E65 DD 77 05      [19]  161         ld  entity_vy(ix), a
                            162 
   7E68 DD 21 11 40   [14]  163         ld  ix, #wallIPos
   7E6C DD 7E 04      [19]  164         ld  a, entity_estado(ix)
   7E6F 3C            [ 4]  165         inc a
   7E70 DD 77 04      [19]  166         ld  entity_estado(ix), a
                            167 
   7E73 C9            [10]  168         ret
                            169 
                            170 
                            171 
   7E74                     172     enemigoIzqAsesinado:
                            173         ;;;;lo cambiamos a color azul
                            174         ;;ld  ix, #enemyIzqPos
                            175         ;;ld  entity_color(ix), #0x0F
                            176         ;; call  entityman_getEntityArray_IX
                            177         ;;call  entityman_getNumEntities_A
                            178         ;;call  rendersys_update
                            179         ;;ld a, #20
                            180         ;;esperaCambioColor1EnemigoI:
                            181         ;;halt
                            182         ;;dec a
                            183         ;;jr nz, esperaCambioColor1EnemigoI
                            184         ;;
                            185         ;;;;lo cambiamos a color rojo
                            186         ;;ld  ix, #enemyIzqPos
                            187         ;;ld  entity_color(ix), #0x0F
                            188         ;;call  entityman_getEntityArray_IX
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (Zilog Z80 / Hitachi HD64180), page 64.
Hexadecimal [16-Bits]



                            189         ;;call  entityman_getNumEntities_A
                            190         ;;call  rendersys_update
                            191         ;;ld a, #20
                            192         ;;esperaCambioColor2EnemigoI:
                            193         ;;halt
                            194         ;;dec a
                            195         ;;jr nz, esperaCambioColor2EnemigoI
                            196         ;;
                            197         ;; ;;lo borramos
                            198         ;;ld  ix, #enemyIzqPos
                            199         ;;ld  entity_color(ix), #0x00
                            200         ;; call  entityman_getEntityArray_IX
                            201         ;;call  entityman_getNumEntities_A
                            202         ;;call  rendersys_update
                            203         ;;ld a, #20
                            204         ;;esperaCambioColor3EnemigoI:
                            205         ;;halt
                            206         ;;dec a
                            207         ;;jr nz, esperaCambioColor3EnemigoI
                            208 
   7E74 CD B8 8C      [17]  209         call borrarEnemigo2
   7E77 CD EC AA      [17]  210         call borrarEspadaIzquierda
   7E7A DD 21 2D 40   [14]  211         ld  ix, #enemyIzqPos
   7E7E DD 36 00 05   [19]  212         ld  entity_x(ix), #5
   7E82 DD 36 04 00   [19]  213         ld  entity_estado(ix), #0
   7E86 CD F2 88      [17]  214         call pintarEnemigo2
                            215 
   7E89 DD 21 18 40   [14]  216         ld  ix, #wallDPos
   7E8D DD 7E 05      [19]  217         ld  a, entity_vy(ix)
   7E90 3D            [ 4]  218         dec a
   7E91 DD 77 05      [19]  219         ld  entity_vy(ix), a
                            220 
   7E94 DD 21 11 40   [14]  221         ld  ix, #wallIPos
   7E98 DD 7E 04      [19]  222         ld  a, entity_estado(ix)
   7E9B 3C            [ 4]  223         inc a
   7E9C DD 77 04      [19]  224         ld  entity_estado(ix), a
   7E9F C9            [10]  225         ret
   7EA0                     226     mueveEspadaDerecha::
                            227 
   7EA0 DD 21 0A 40   [14]  228         ld  ix, #espadaPos ;;enemyPos
   7EA4 DD 7E 04      [19]  229         ld  a, entity_estado(ix)
   7EA7 3D            [ 4]  230         dec a
   7EA8 28 0C         [12]  231         jr  z,   estabaizquierda  ;;(vx era 1)
   7EAA DD 7E 00      [19]  232         ld  a, entity_x(ix)
   7EAD 3C            [ 4]  233         inc a
   7EAE DD 77 00      [19]  234         ld  entity_x(ix), a
   7EB1 DD 36 04 00   [19]  235         ld  entity_estado(ix), #0
                            236         ;;call  entityman_getEntityArray_IX
                            237         ;;call  entityman_getNumEntities_A
                            238         ;;call  rendersys_update
   7EB5 C9            [10]  239         ret
                            240 
   7EB6                     241     estabaizquierda:
   7EB6 DD 21 03 40   [14]  242         ld  ix, #playerPos
   7EBA DD 46 00      [19]  243         ld  b, entity_x(ix)
...
Hexadecimal [16-Bits]
   ...
   7EBD 04            [ 4]  244         inc b
   7EBE 04            [ 4]  245         inc b
   7EBF DD 21 0A 40   [14]  246         ld  ix, #espadaPos
   7EC3 DD 70 00      [19]  247         ld  entity_x(ix), b
   7EC6 DD 36 04 00   [19]  248         ld  entity_estado(ix), #0
                            249         ;;call  entityman_getEntityArray_IX
                            250         ;;call  entityman_getNumEntities_A
                            251         ;;call  rendersys_update
                            252 
   7ECA C9            [10]  253         ret
                            254 
   7ECB                     255     mueveEspadaIzquierda::
                            256 
   7ECB DD 21 0A 40   [14]  257         ld  ix, #espadaPos
   7ECF DD 7E 04      [19]  258         ld  a, entity_estado(ix)
   7ED2 3D            [ 4]  259         dec a
   7ED3 20 0C         [12]  260         jr  nz,   estabaderecha ;;(vx era 1)
   7ED5 DD 7E 00      [19]  261         ld  a, entity_x(ix)
   7ED8 3D            [ 4]  262         dec a
   7ED9 DD 77 00      [19]  263         ld  entity_x(ix), a
   7EDC DD 36 04 01   [19]  264         ld  entity_estado(ix), #1
                            265         ;;call  entityman_getEntityArray_IX
                            266         ;;call  entityman_getNumEntities_A
                            267         ;;call  rendersys_update
   7EE0 C9            [10]  268         ret
                            269 
   7EE1                     270     estabaderecha:
   7EE1 DD 21 03 40   [14]  271         ld  ix, #playerPos
   7EE5 DD 46 00      [19]  272         ld  b, entity_x(ix)
   7EE8 05            [ 4]  273         dec b
   7EE9 05            [ 4]  274         dec b
   7EEA DD 21 0A 40   [14]  275         ld  ix, #espadaPos
   7EEE DD 70 00      [19]  276         ld  entity_x(ix), b
   7EF1 DD 36 04 01   [19]  277         ld  entity_estado(ix), #1
                            278         ;;call  entityman_getEntityArray_IX
                            279         ;;call  entityman_getNumEntities_A
                            280         ;;call  rendersys_update
                            281 
   7EF5 C9            [10]  282         ret
