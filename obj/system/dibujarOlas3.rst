...
Hexadecimal [16-Bits]
                             ...
                             18 
                             19 ;;DIBUJAMOS LAS OLAS EN POSICION MOVIDA PARA DAR EFECTO
   4744                      20 olas3::
   4744 3E 4B         [ 7]   21     ld a, #0x4B
   4746                      22 olas1:
   4746 F5            [11]   23     push af
                             24     
   4747 11 00 C0      [10]   25     ld      de, #0xC000        ;;Puntero a la posición en pantalla (COOO sería el inicio de la pantalla)
   474A 4F            [ 4]   26     ld      c,  a              ;;Coordenada X 
   474B 06 97         [ 7]   27     ld      b,  #0x97         ;;Coordenada Y 
   474D CD 6C B0      [17]   28     call cpct_getScreenPtr_asm  ;;Función que calcula la dirección de memoria de video con esos parámetros
                             29 
   4750 EB            [ 4]   30     ex      de, hl             ;;Intercambia los 2 valores (supongo que la fucion de dibujo lo usará)
   4751 3E 0E         [ 7]   31     ld      a,  #0x0E          ;;Color (en la posición de la entidad)
   4753 0E 01         [ 7]   32     ld      c,  #1        ;;Ancho (en la posición de la entidad)
   4755 06 04         [ 7]   33     ld      b,  #4         ;;Alto (en la posición de la entidad)
   4757 CD C1 AF      [17]   34     call cpct_drawSolidBox_asm  ;;Función de dibujado de cpc
                             35 
   475A F1            [10]   36     pop af
   475B 3D            [ 4]   37     dec a
   475C 28 11         [12]   38     jr z, final
   475E 3D            [ 4]   39     dec a
   475F 28 0E         [12]   40     jr z, final
   4761 3D            [ 4]   41     dec a
   4762 28 0B         [12]   42     jr z, final
   4764 3D            [ 4]   43     dec a
   4765 28 08         [12]   44     jr z, final
   4767 3D            [ 4]   45     dec a
   4768 28 05         [12]   46     jr z, final
   476A 3D            [ 4]   47     dec a
   476B 28 02         [12]   48     jr z, final
   476D 20 D7         [12]   49     jr nz, olas1
   476F                      50 final:
                             51 
   476F 3E 4A         [ 7]   52 ld a, #0x4A
   4771                      53 olas22:
   4771 F5            [11]   54     push af
                             55     
   4772 11 00 C0      [10]   56     ld      de, #0xC000        ;;Puntero a la posición en pantalla (COOO sería el inicio de la pantalla)
   4775 4F            [ 4]   57     ld      c,  a              ;;Coordenada X 
   4776 06 96         [ 7]   58     ld      b,  #0x96         ;;Coordenada Y 
   4778 CD 6C B0      [17]   59     call cpct_getScreenPtr_asm  ;;Función que calcula la dirección de memoria de video con esos parámetros
                             60 
   477B EB            [ 4]   61     ex      de, hl             ;;Intercambia los 2 valores (supongo que la fucion de dibujo lo usará)
   477C 3E 0E         [ 7]   62     ld      a,  #0x0E          ;;Color (en la posición de la entidad)
   477E 0E 01         [ 7]   63     ld      c,  #1        ;;Ancho (en la posición de la entidad)
   4780 06 04         [ 7]   64     ld      b,  #4         ;;Alto (en la posición de la entidad)
   4782 CD C1 AF      [17]   65     call cpct_drawSolidBox_asm  ;;Función de dibujado de cpc
                             66 
   4785 F1            [10]   67     pop af
   4786 3D            [ 4]   68     dec a
   4787 28 11         [12]   69     jr z, final2
   4789 3D            [ 4]   70     dec a
   478A 28 0E         [12]   71     jr z, final2
   478C 3D            [ 4]   72     dec a
...
Hexadecimal [16-Bits]
   ...
   478D 28 0B         [12]   73     jr z, final2
   478F 3D            [ 4]   74     dec a
   4790 28 08         [12]   75     jr z, final2
   4792 3D            [ 4]   76     dec a
   4793 28 05         [12]   77     jr z, final2
   4795 3D            [ 4]   78     dec a
   4796 28 02         [12]   79     jr z, final2
   4798 20 D7         [12]   80     jr nz, olas22
   479A                      81 final2:
                             82 
   479A 3E 49         [ 7]   83 ld a, #0x49
   479C                      84 olas33:
   479C F5            [11]   85     push af
                             86     
   479D 11 00 C0      [10]   87     ld      de, #0xC000        ;;Puntero a la posición en pantalla (COOO sería el inicio de la pantalla)
   47A0 4F            [ 4]   88     ld      c,  a              ;;Coordenada X 
   47A1 06 95         [ 7]   89     ld      b,  #0x95         ;;Coordenada Y 
   47A3 CD 6C B0      [17]   90     call cpct_getScreenPtr_asm  ;;Función que calcula la dirección de memoria de video con esos parámetros
                             91 
   47A6 EB            [ 4]   92     ex      de, hl             ;;Intercambia los 2 valores (supongo que la fucion de dibujo lo usará)
   47A7 3E 0E         [ 7]   93     ld      a,  #0x0E          ;;Color (en la posición de la entidad)
   47A9 0E 01         [ 7]   94     ld      c,  #1        ;;Ancho (en la posición de la entidad)
   47AB 06 04         [ 7]   95     ld      b,  #4         ;;Alto (en la posición de la entidad)
   47AD CD C1 AF      [17]   96     call cpct_drawSolidBox_asm  ;;Función de dibujado de cpc
                             97 
   47B0 F1            [10]   98     pop af
   47B1 3D            [ 4]   99     dec a
   47B2 28 11         [12]  100     jr z, final3
   47B4 3D            [ 4]  101     dec a
   47B5 28 0E         [12]  102     jr z, final3
   47B7 3D            [ 4]  103     dec a
   47B8 28 0B         [12]  104     jr z, final3
   47BA 3D            [ 4]  105      dec a
   47BB 28 08         [12]  106     jr z, final3
   47BD 3D            [ 4]  107     dec a
   47BE 28 05         [12]  108     jr z, final3
   47C0 3D            [ 4]  109     dec a
   47C1 28 02         [12]  110     jr z, final3
   47C3 20 D7         [12]  111     jr nz, olas33
   47C5                     112 final3:
                            113 
   47C5 3E 48         [ 7]  114 ld a, #0x48
   47C7                     115 olas4:
   47C7 F5            [11]  116     push af
                            117     
   47C8 11 00 C0      [10]  118     ld      de, #0xC000        ;;Puntero a la posición en pantalla (COOO sería el inicio de la pantalla)
   47CB 4F            [ 4]  119     ld      c,  a              ;;Coordenada X 
   47CC 06 94         [ 7]  120     ld      b,  #0x94         ;;Coordenada Y 
   47CE CD 6C B0      [17]  121     call cpct_getScreenPtr_asm  ;;Función que calcula la dirección de memoria de video con esos parámetros
                            122 
   47D1 EB            [ 4]  123     ex      de, hl             ;;Intercambia los 2 valores (supongo que la fucion de dibujo lo usará)
   47D2 3E 0E         [ 7]  124     ld      a,  #0x0E          ;;Color (en la posición de la entidad)
   47D4 0E 01         [ 7]  125     ld      c,  #1        ;;Ancho (en la posición de la entidad)
   47D6 06 04         [ 7]  126     ld      b,  #4         ;;Alto (en la posición de la entidad)
   47D8 CD C1 AF      [17]  127     call cpct_drawSolidBox_asm  ;;Función de dibujado de cpc
...
Hexadecimal [16-Bits]
                            ...
                            128 
   47DB F1            [10]  129     pop af
   47DC 3D            [ 4]  130     dec a
   47DD 28 11         [12]  131     jr z, final4
   47DF 3D            [ 4]  132     dec a
   47E0 28 0E         [12]  133     jr z, final4
   47E2 3D            [ 4]  134     dec a
   47E3 28 0B         [12]  135     jr z, final4
   47E5 3D            [ 4]  136     dec a
   47E6 28 08         [12]  137     jr z, final4
   47E8 3D            [ 4]  138     dec a
   47E9 28 05         [12]  139     jr z, final4
   47EB 3D            [ 4]  140     dec a
   47EC 28 02         [12]  141     jr z, final4
   47EE 20 D7         [12]  142     jr nz, olas4
   47F0                     143 final4:
                            144 
                            145 
                            146 
                            147 ;;AQUI EMPIEZA LAS OLAS EN LA OTRA DIRECCION
   47F0 3E 4C         [ 7]  148 ld a, #0x4C
   47F2                     149 olas7:
   47F2 F5            [11]  150     push af
                            151     
   47F3 11 00 C0      [10]  152     ld      de, #0xC000        ;;Puntero a la posición en pantalla (COOO sería el inicio de la pantalla)
   47F6 4F            [ 4]  153     ld      c,  a              ;;Coordenada X 
   47F7 06 97         [ 7]  154     ld      b,  #0x97         ;;Coordenada Y 
   47F9 CD 6C B0      [17]  155     call cpct_getScreenPtr_asm  ;;Función que calcula la dirección de memoria de video con esos parámetros
                            156 
   47FC EB            [ 4]  157     ex      de, hl             ;;Intercambia los 2 valores (supongo que la fucion de dibujo lo usará)
   47FD 3E 0E         [ 7]  158     ld      a,  #0x0E          ;;Color (en la posición de la entidad)
   47FF 0E 01         [ 7]  159     ld      c,  #1        ;;Ancho (en la posición de la entidad)
   4801 06 04         [ 7]  160     ld      b,  #4         ;;Alto (en la posición de la entidad)
   4803 CD C1 AF      [17]  161     call cpct_drawSolidBox_asm  ;;Función de dibujado de cpc
                            162 
   4806 F1            [10]  163     pop af
   4807 3D            [ 4]  164     dec a
   4808 28 11         [12]  165     jr z, final7
   480A 3D            [ 4]  166     dec a
   480B 28 0E         [12]  167     jr z, final7
   480D 3D            [ 4]  168     dec a
   480E 28 0B         [12]  169     jr z, final7
   4810 3D            [ 4]  170     dec a
   4811 28 08         [12]  171     jr z, final7
   4813 3D            [ 4]  172     dec a
   4814 28 05         [12]  173     jr z, final7
   4816 3D            [ 4]  174     dec a
   4817 28 02         [12]  175     jr z, final7
   4819 20 D7         [12]  176     jr nz, olas7
   481B                     177 final7:
                            178 
   481B 3E 4D         [ 7]  179 ld a, #0x4D
   481D                     180 olas8:
   481D F5            [11]  181     push af
                            182     
...
Hexadecimal [16-Bits]
   ...
   481E 11 00 C0      [10]  183     ld      de, #0xC000        ;;Puntero a la posición en pantalla (COOO sería el inicio de la pantalla)
   4821 4F            [ 4]  184     ld      c,  a              ;;Coordenada X 
   4822 06 96         [ 7]  185     ld      b,  #0x96         ;;Coordenada Y 
   4824 CD 6C B0      [17]  186     call cpct_getScreenPtr_asm  ;;Función que calcula la dirección de memoria de video con esos parámetros
                            187 
   4827 EB            [ 4]  188     ex      de, hl             ;;Intercambia los 2 valores (supongo que la fucion de dibujo lo usará)
   4828 3E 0E         [ 7]  189     ld      a,  #0x0E          ;;Color (en la posición de la entidad)
   482A 0E 01         [ 7]  190     ld      c,  #1        ;;Ancho (en la posición de la entidad)
   482C 06 04         [ 7]  191     ld      b,  #4         ;;Alto (en la posición de la entidad)
   482E CD C1 AF      [17]  192     call cpct_drawSolidBox_asm  ;;Función de dibujado de cpc
                            193 
   4831 F1            [10]  194     pop af
   4832 3D            [ 4]  195     dec a
   4833 28 11         [12]  196     jr z, final8
   4835 3D            [ 4]  197     dec a
   4836 28 0E         [12]  198     jr z, final8
   4838 3D            [ 4]  199     dec a
   4839 28 0B         [12]  200     jr z, final8
   483B 3D            [ 4]  201     dec a
   483C 28 08         [12]  202     jr z, final8
   483E 3D            [ 4]  203     dec a
   483F 28 05         [12]  204     jr z, final8
   4841 3D            [ 4]  205     dec a
   4842 28 02         [12]  206     jr z, final8
   4844 20 D7         [12]  207     jr nz, olas8
   4846                     208 final8:
                            209 
   4846 3E 4E         [ 7]  210 ld a, #0x4E
   4848                     211 olas9:
   4848 F5            [11]  212     push af
                            213     
   4849 11 00 C0      [10]  214     ld      de, #0xC000        ;;Puntero a la posición en pantalla (COOO sería el inicio de la pantalla)
   484C 4F            [ 4]  215     ld      c,  a              ;;Coordenada X 
   484D 06 95         [ 7]  216     ld      b,  #0x95         ;;Coordenada Y 
   484F CD 6C B0      [17]  217     call cpct_getScreenPtr_asm  ;;Función que calcula la dirección de memoria de video con esos parámetros
                            218 
   4852 EB            [ 4]  219     ex      de, hl             ;;Intercambia los 2 valores (supongo que la fucion de dibujo lo usará)
   4853 3E 0E         [ 7]  220     ld      a,  #0x0E          ;;Color (en la posición de la entidad)
   4855 0E 01         [ 7]  221     ld      c,  #1        ;;Ancho (en la posición de la entidad)
   4857 06 04         [ 7]  222     ld      b,  #4         ;;Alto (en la posición de la entidad)
   4859 CD C1 AF      [17]  223     call cpct_drawSolidBox_asm  ;;Función de dibujado de cpc
                            224 
   485C F1            [10]  225     pop af
   485D 3D            [ 4]  226     dec a
   485E 28 11         [12]  227     jr z, final9
   4860 3D            [ 4]  228     dec a
   4861 28 0E         [12]  229     jr z, final9
   4863 3D            [ 4]  230     dec a
   4864 28 0B         [12]  231     jr z, final9
   4866 3D            [ 4]  232      dec a
   4867 28 08         [12]  233     jr z, final9
   4869 3D            [ 4]  234     dec a
   486A 28 05         [12]  235     jr z, final9
   486C 3D            [ 4]  236     dec a
   486D 28 02         [12]  237     jr z, final9
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (Zilog Z80 / Hitachi HD64180), page 59.
Hexadecimal [16-Bits]



   486F 20 D7         [12]  238     jr nz, olas9
   4871                     239 final9:
                            240 
   4871 3E 4F         [ 7]  241 ld a, #0x4F
   4873                     242 olas10:
   4873 F5            [11]  243     push af
                            244     
   4874 11 00 C0      [10]  245     ld      de, #0xC000        ;;Puntero a la posición en pantalla (COOO sería el inicio de la pantalla)
   4877 4F            [ 4]  246     ld      c,  a              ;;Coordenada X 
   4878 06 94         [ 7]  247     ld      b,  #0x94        ;;Coordenada Y 
   487A CD 6C B0      [17]  248     call cpct_getScreenPtr_asm  ;;Función que calcula la dirección de memoria de video con esos parámetros
                            249 
   487D EB            [ 4]  250     ex      de, hl             ;;Intercambia los 2 valores (supongo que la fucion de dibujo lo usará)
   487E 3E 0E         [ 7]  251     ld      a,  #0x0E          ;;Color (en la posición de la entidad)
   4880 0E 01         [ 7]  252     ld      c,  #1        ;;Ancho (en la posición de la entidad)
   4882 06 04         [ 7]  253     ld      b,  #4         ;;Alto (en la posición de la entidad)
   4884 CD C1 AF      [17]  254     call cpct_drawSolidBox_asm  ;;Función de dibujado de cpc
                            255 
   4887 F1            [10]  256     pop af
   4888 3D            [ 4]  257     dec a
   4889 28 11         [12]  258     jr z, final10
   488B 3D            [ 4]  259     dec a
   488C 28 0E         [12]  260     jr z, final10
   488E 3D            [ 4]  261     dec a
   488F 28 0B         [12]  262     jr z, final10
   4891 3D            [ 4]  263     dec a
   4892 28 08         [12]  264     jr z, final10
   4894 3D            [ 4]  265     dec a
   4895 28 05         [12]  266     jr z, final10
   4897 3D            [ 4]  267     dec a
   4898 28 02         [12]  268     jr z, final10
   489A 20 D7         [12]  269     jr nz, olas10
   489C                     270 final10:
                            271 
                            272 ;;EMPIEZAN LAS OLAS DE DEBAJO
                            273  
                            274 
                            275 
   489C C9            [10]  276 ret
