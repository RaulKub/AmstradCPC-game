...
Hexadecimal [16-Bits]
   ...
   A123 30 00                19 Escribir0: .asciz "0"
   A125 31 00                20 Escribir1: .asciz "1"
   A127 32 00                21 Escribir2: .asciz "2"
   A129 33 00                22 Escribir3: .asciz "3"
   A12B 34 00                23 Escribir4: .asciz "4"
   A12D 35 00                24 Escribir5: .asciz "5"
   A12F 36 00                25 Escribir6: .asciz "6"
   A131 37 00                26 Escribir7: .asciz "7"
   A133 38 00                27 Escribir8: .asciz "8"
   A135 39 00                28 Escribir9: .asciz "9"
                             29 
                             30 
   A137                      31    pintarCeroDecenas2::
   A137 16 02         [ 7]   32     ld    d, #2         ;; D = Background PEN (0)
   A139 1E 03         [ 7]   33    ld    e, #3         ;; E = Foreground PEN (3) ;;3 rojo, 2 azul, 1 amarillo, 0 fondo, mas de 3 multicolor
                             34 
   A13B CD 88 B0      [17]   35    call cpct_setDrawCharM1_asm   ;; Set draw char colours
                             36 
                             37    ;; Calculate a video-memory location for printing a string
   A13E 11 00 C0      [10]   38    ld   de, #CPCT_VMEM_START_ASM ;; DE = Pointer to start of the screen
   A141 06 BE         [ 7]   39    ld    b, #190                  ;; B = y coordinate (24 = 0x18)
   A143 0E 45         [ 7]   40    ld    c, #69                 ;; C = x coordinate (16 = 0x10)
                             41 
   A145 CD 6C B0      [17]   42    call cpct_getScreenPtr_asm    ;; Calculate video memory location and return it in HL
                             43 
   ...
   A148 FD 21 23 A1   [14]   47    ld   iy, #Escribir0    ;; IY = Pointer to the string 
                             48    
   A14C CD 63 AE      [17]   49    call cpct_drawStringM1_asm
   A14F C9            [10]   50    ret
                             51 
   A150                      52    pintarUnoDecenas2::
   A150 16 02         [ 7]   53     ld    d, #2         ;; D = Background PEN (0)
   A152 1E 03         [ 7]   54    ld    e, #3         ;; E = Foreground PEN (3) ;;3 rojo, 2 azul, 1 amarillo, 0 fondo, mas de 3 multicolor
                             55 
   A154 CD 88 B0      [17]   56    call cpct_setDrawCharM1_asm   ;; Set draw char colours
                             57 
                             58    ;; Calculate a video-memory location for printing a string
   A157 11 00 C0      [10]   59    ld   de, #CPCT_VMEM_START_ASM ;; DE = Pointer to start of the screen
   A15A 06 BE         [ 7]   60    ld    b, #190                  ;; B = y coordinate (24 = 0x18)
   A15C 0E 45         [ 7]   61    ld    c, #69                 ;; C = x coordinate (16 = 0x10)
                             62 
   A15E CD 6C B0      [17]   63    call cpct_getScreenPtr_asm    ;; Calculate video memory location and return it in HL
                             64 
   ...
   A161 FD 21 25 A1   [14]   68    ld   iy, #Escribir1    ;; IY = Pointer to the string 
                             69    
   A165 CD 63 AE      [17]   70    call cpct_drawStringM1_asm
   A168 C9            [10]   71    ret
                             72 
   A169                      73    pintarDosDecenas2::
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (Zilog Z80 / Hitachi HD64180), page 57.
Hexadecimal [16-Bits]



   A169 16 02         [ 7]   74     ld    d, #2         ;; D = Background PEN (0)
   A16B 1E 03         [ 7]   75    ld    e, #3         ;; E = Foreground PEN (3) ;;3 rojo, 2 azul, 1 amarillo, 0 fondo, mas de 3 multicolor
                             76 
   A16D CD 88 B0      [17]   77    call cpct_setDrawCharM1_asm   ;; Set draw char colours
                             78 
                             79    ;; Calculate a video-memory location for printing a string
   A170 11 00 C0      [10]   80    ld   de, #CPCT_VMEM_START_ASM ;; DE = Pointer to start of the screen
   A173 06 BE         [ 7]   81    ld    b, #190                  ;; B = y coordinate (24 = 0x18)
   A175 0E 45         [ 7]   82    ld    c, #69                 ;; C = x coordinate (16 = 0x10)
                             83 
   A177 CD 6C B0      [17]   84    call cpct_getScreenPtr_asm    ;; Calculate video memory location and return it in HL
                             85 
   ...
   A17A FD 21 27 A1   [14]   89    ld   iy, #Escribir2    ;; IY = Pointer to the string 
                             90    
   A17E CD 63 AE      [17]   91    call cpct_drawStringM1_asm
   A181 C9            [10]   92    ret
   A182                      93    pintarTresDecenas2::
   A182 16 02         [ 7]   94     ld    d, #2         ;; D = Background PEN (0)
   A184 1E 03         [ 7]   95    ld    e, #3         ;; E = Foreground PEN (3) ;;3 rojo, 2 azul, 1 amarillo, 0 fondo, mas de 3 multicolor
                             96 
   A186 CD 88 B0      [17]   97    call cpct_setDrawCharM1_asm   ;; Set draw char colours
                             98 
                             99    ;; Calculate a video-memory location for printing a string
   A189 11 00 C0      [10]  100    ld   de, #CPCT_VMEM_START_ASM ;; DE = Pointer to start of the screen
   A18C 06 BE         [ 7]  101    ld    b, #190                  ;; B = y coordinate (24 = 0x18)
   A18E 0E 45         [ 7]  102    ld    c, #69                 ;; C = x coordinate (16 = 0x10)
                            103 
   A190 CD 6C B0      [17]  104    call cpct_getScreenPtr_asm    ;; Calculate video memory location and return it in HL
                            105 
   ...
   A193 FD 21 29 A1   [14]  109    ld   iy, #Escribir3    ;; IY = Pointer to the string 
                            110    
   A197 CD 63 AE      [17]  111    call cpct_drawStringM1_asm
   A19A C9            [10]  112    ret
   A19B                     113    pintarCuatroDecenas2::
   A19B 16 02         [ 7]  114     ld    d, #2         ;; D = Background PEN (0)
   A19D 1E 03         [ 7]  115    ld    e, #3         ;; E = Foreground PEN (3) ;;3 rojo, 2 azul, 1 amarillo, 0 fondo, mas de 3 multicolor
                            116 
   A19F CD 88 B0      [17]  117    call cpct_setDrawCharM1_asm   ;; Set draw char colours
                            118 
                            119    ;; Calculate a video-memory location for printing a string
   A1A2 11 00 C0      [10]  120    ld   de, #CPCT_VMEM_START_ASM ;; DE = Pointer to start of the screen
   A1A5 06 BE         [ 7]  121    ld    b, #190                  ;; B = y coordinate (24 = 0x18)
   A1A7 0E 45         [ 7]  122    ld    c, #69                 ;; C = x coordinate (16 = 0x10)
                            123 
   A1A9 CD 6C B0      [17]  124    call cpct_getScreenPtr_asm    ;; Calculate video memory location and return it in HL
                            125 
...
Hexadecimal [16-Bits]
   ...
   A1AC FD 21 2B A1   [14]  129    ld   iy, #Escribir4    ;; IY = Pointer to the string 
                            130    
   A1B0 CD 63 AE      [17]  131    call cpct_drawStringM1_asm
   A1B3 C9            [10]  132    ret
   A1B4                     133    pintarCincoDecenas2::
   A1B4 16 02         [ 7]  134     ld    d, #2         ;; D = Background PEN (0)
   A1B6 1E 03         [ 7]  135    ld    e, #3         ;; E = Foreground PEN (3) ;;3 rojo, 2 azul, 1 amarillo, 0 fondo, mas de 3 multicolor
                            136 
   A1B8 CD 88 B0      [17]  137    call cpct_setDrawCharM1_asm   ;; Set draw char colours
                            138 
                            139    ;; Calculate a video-memory location for printing a string
   A1BB 11 00 C0      [10]  140    ld   de, #CPCT_VMEM_START_ASM ;; DE = Pointer to start of the screen
   A1BE 06 BE         [ 7]  141    ld    b, #190                  ;; B = y coordinate (24 = 0x18)
   A1C0 0E 45         [ 7]  142    ld    c, #69                 ;; C = x coordinate (16 = 0x10)
                            143 
   A1C2 CD 6C B0      [17]  144    call cpct_getScreenPtr_asm    ;; Calculate video memory location and return it in HL
                            145 
   ...
   A1C5 FD 21 2D A1   [14]  149    ld   iy, #Escribir5    ;; IY = Pointer to the string 
                            150    
   A1C9 CD 63 AE      [17]  151    call cpct_drawStringM1_asm
   A1CC C9            [10]  152    ret
   A1CD                     153    pintarSeisDecenas2::
   A1CD 16 02         [ 7]  154     ld    d, #2         ;; D = Background PEN (0)
   A1CF 1E 03         [ 7]  155    ld    e, #3         ;; E = Foreground PEN (3) ;;3 rojo, 2 azul, 1 amarillo, 0 fondo, mas de 3 multicolor
                            156 
   A1D1 CD 88 B0      [17]  157    call cpct_setDrawCharM1_asm   ;; Set draw char colours
                            158 
                            159    ;; Calculate a video-memory location for printing a string
   A1D4 11 00 C0      [10]  160    ld   de, #CPCT_VMEM_START_ASM ;; DE = Pointer to start of the screen
   A1D7 06 BE         [ 7]  161    ld    b, #190                  ;; B = y coordinate (24 = 0x18)
   A1D9 0E 45         [ 7]  162    ld    c, #69                 ;; C = x coordinate (16 = 0x10)
                            163 
   A1DB CD 6C B0      [17]  164    call cpct_getScreenPtr_asm    ;; Calculate video memory location and return it in HL
                            165 
   ...
   A1DE FD 21 2F A1   [14]  169    ld   iy, #Escribir6    ;; IY = Pointer to the string 
                            170    
   A1E2 CD 63 AE      [17]  171    call cpct_drawStringM1_asm
   A1E5 C9            [10]  172    ret
   A1E6                     173    pintarSieteDecenas2::
   A1E6 16 02         [ 7]  174     ld    d, #2         ;; D = Background PEN (0)
   A1E8 1E 03         [ 7]  175    ld    e, #3         ;; E = Foreground PEN (3) ;;3 rojo, 2 azul, 1 amarillo, 0 fondo, mas de 3 multicolor
                            176 
   A1EA CD 88 B0      [17]  177    call cpct_setDrawCharM1_asm   ;; Set draw char colours
                            178 
                            179    ;; Calculate a video-memory location for printing a string
   A1ED 11 00 C0      [10]  180    ld   de, #CPCT_VMEM_START_ASM ;; DE = Pointer to start of the screen
   A1F0 06 BE         [ 7]  181    ld    b, #190                  ;; B = y coordinate (24 = 0x18)
   A1F2 0E 45         [ 7]  182    ld    c, #69                 ;; C = x coordinate (16 = 0x10)
                            183 
...
Hexadecimal [16-Bits]
   ...
   A1F4 CD 6C B0      [17]  184    call cpct_getScreenPtr_asm    ;; Calculate video memory location and return it in HL
                            185 
   ...
   A1F7 FD 21 31 A1   [14]  189    ld   iy, #Escribir7    ;; IY = Pointer to the string 
                            190    
   A1FB CD 63 AE      [17]  191    call cpct_drawStringM1_asm
   A1FE C9            [10]  192    ret
   A1FF                     193    pintarOchoDecenas2::
   A1FF 16 02         [ 7]  194     ld    d, #2         ;; D = Background PEN (0)
   A201 1E 03         [ 7]  195    ld    e, #3         ;; E = Foreground PEN (3) ;;3 rojo, 2 azul, 1 amarillo, 0 fondo, mas de 3 multicolor
                            196 
   A203 CD 88 B0      [17]  197    call cpct_setDrawCharM1_asm   ;; Set draw char colours
                            198 
                            199    ;; Calculate a video-memory location for printing a string
   A206 11 00 C0      [10]  200    ld   de, #CPCT_VMEM_START_ASM ;; DE = Pointer to start of the screen
   A209 06 BE         [ 7]  201    ld    b, #190                  ;; B = y coordinate (24 = 0x18)
   A20B 0E 45         [ 7]  202    ld    c, #69                 ;; C = x coordinate (16 = 0x10)
                            203 
   A20D CD 6C B0      [17]  204    call cpct_getScreenPtr_asm    ;; Calculate video memory location and return it in HL
                            205 
   ...
   A210 FD 21 33 A1   [14]  209    ld   iy, #Escribir8    ;; IY = Pointer to the string 
                            210    
   A214 CD 63 AE      [17]  211    call cpct_drawStringM1_asm
   A217 C9            [10]  212    ret
   A218                     213    pintarNueveDecenas2::
   A218 16 02         [ 7]  214     ld    d, #2         ;; D = Background PEN (0)
   A21A 1E 03         [ 7]  215    ld    e, #3         ;; E = Foreground PEN (3) ;;3 rojo, 2 azul, 1 amarillo, 0 fondo, mas de 3 multicolor
                            216 
   A21C CD 88 B0      [17]  217    call cpct_setDrawCharM1_asm   ;; Set draw char colours
                            218 
                            219    ;; Calculate a video-memory location for printing a string
   A21F 11 00 C0      [10]  220    ld   de, #CPCT_VMEM_START_ASM ;; DE = Pointer to start of the screen
   A222 06 BE         [ 7]  221    ld    b, #190                  ;; B = y coordinate (24 = 0x18)
   A224 0E 45         [ 7]  222    ld    c, #69                 ;; C = x coordinate (16 = 0x10)
                            223 
   A226 CD 6C B0      [17]  224    call cpct_getScreenPtr_asm    ;; Calculate video memory location and return it in HL
                            225 
   ...
   A229 FD 21 35 A1   [14]  229    ld   iy, #Escribir9    ;; IY = Pointer to the string 
                            230    
   A22D CD 63 AE      [17]  231    call cpct_drawStringM1_asm
   A230 C9            [10]  232    ret
