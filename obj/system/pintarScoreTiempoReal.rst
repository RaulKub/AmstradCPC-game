...
Hexadecimal [16-Bits]
                             ...
                             19 .include "system/pintarUnidadesDecenasReal.h.s"
                              1 ;;This file is part of Kubso.
                              2 ;;
                              3 ;;Kubso is free software: you can redistribute it and/or modify
                              4 ;;it under the terms of the GNU General Public License as published by
                             ...
                             13 ;;You should have received a copy of the GNU General Public License
                             14 ;;along with Kubso.  If not, see <https://www.gnu.org/licenses/>.
                             15 .globl pintarCeroDecenas2
                             16 .globl pintarUnoDecenas2
                             17 .globl pintarDosDecenas2
                             18 .globl pintarTresDecenas2
                             19 .globl pintarCuatroDecenas2
                             20 .globl pintarCincoDecenas2
                             21 .globl pintarSeisDecenas2
                             22 .globl pintarSieteDecenas2
                             23 .globl pintarOchoDecenas2
                             24 .globl pintarNueveDecenas2
                             25 
                             26 .globl pintarCeroUnidades2
                             27 .globl pintarUnoUnidades2
                             28 .globl pintarDosUnidades2
                             29 .globl pintarTresUnidades2
                             30 .globl pintarCuatroUnidades2
                             31 .globl pintarCincoUnidades2
                             32 .globl pintarSeisUnidades2
                             33 .globl pintarSieteUnidades2
                             34 .globl pintarOchoUnidades2
                             35 .globl pintarNueveUnidades2
...
Hexadecimal [16-Bits]
                             ...
                             20 
   6839 53 63 6F 72 65 3A    21 Score: .asciz "Score: "
        20 00
                             22 
   6841 30 00                23 Escribir0: .asciz "0"
   6843 31 00                24 Escribir1: .asciz "1"
   6845 32 00                25 Escribir2: .asciz "2"
   6847 33 00                26 Escribir3: .asciz "3"
   6849 34 00                27 Escribir4: .asciz "4"
   684B 35 00                28 Escribir5: .asciz "5"
   684D 36 00                29 Escribir6: .asciz "6"
   684F 37 00                30 Escribir7: .asciz "7"
   6851 38 00                31 Escribir8: .asciz "8"
   6853 39 00                32 Escribir9: .asciz "9"
                             33 
   6855                      34 ScoreReal::
                             35 ;;    ld    d, #2         ;; D = Background PEN (0)
                             36 ;;   ld    e, #3         ;; E = Foreground PEN (3) ;;3 rojo, 2 azul, 1 amarillo, 0 fondo, mas de 3 multicolor
                             37 ;;
                             38 ;;   call cpct_setDrawCharM1_asm   ;; Set draw char colours
                             39 ;;
                             40 ;;   ;; Calculate a video-memory location for printing a string
                             41 ;;   ld   de, #CPCT_VMEM_START_ASM ;; DE = Pointer to start of the screen
                             42 ;;   ld    b, #34                  ;; B = y coordinate (24 = 0x18)
                             43 ;;   ld    c, #12                 ;; C = x coordinate (16 = 0x10)
                             44 ;;
                             45 ;;   call cpct_getScreenPtr_asm    ;; Calculate video memory location and return it in HL
                             46 ;;
                             47 ;;   ;; Print the string in video memory
                             48 ;;   ;; HL already points to video memory, as it is the return
                             49 ;;   ;; value from cpct_getScreenPtr_asm
                             50 ;;   ld   iy, #Score    ;; IY = Pointer to the string 
                             51 ;;   
                             52 ;;   call cpct_drawStringM1_asm
                             53 ;;
   6855 00                   54 centenas: .db #0
                             55 
   6856 DD 21 11 40   [14]   56    ld ix, #wallIPos
   685A DD 7E 04      [19]   57    ld a, entity_estado(ix)
   685D DD 46 05      [19]   58    ld b, entity_vy(ix)
                             59 
   6860 04            [ 4]   60    inc b 
   6861 05            [ 4]   61    dec b 
   6862 20 02         [12]   62    jr nz, sumarAereos
   6864 18 08         [12]   63    jr scoreEnA
   6866                      64    sumarAereos:
   6866 3C            [ 4]   65    inc a
   6867 3C            [ 4]   66    inc a
   6868 3C            [ 4]   67    inc a
   ...
   686A 3C            [ 4]   69    inc a
   686B 05            [ 4]   70    dec b
   686C 20 F8         [12]   71    jr nz, sumarAereos
   686E                      72    scoreEnA:
   686E 16 00         [ 7]   73    ld d, #0  ;;decenas
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (Zilog Z80 / Hitachi HD64180), page 58.
Hexadecimal [16-Bits]



   6870 0E 00         [ 7]   74    ld c, #0  ;;unidades
                             75 
   6872 3C            [ 4]   76    inc a 
   6873 3D            [ 4]   77    dec a
   6874 20 09         [12]   78    jr nz, obtenerUnidades
   6876 CD 37 A1      [17]   79    call pintarCeroDecenas2
   6879 CD 3F 67      [17]   80    call pintarCeroUnidades2
   687C C3 94 69      [10]   81    jp finscore
   687F                      82    obtenerUnidades:
   687F 0C            [ 4]   83    inc c 
   6880 3D            [ 4]   84    dec a 
   6881 28 54         [12]   85    jr z, descuentoFin
   6883 0C            [ 4]   86    inc c 
   6884 3D            [ 4]   87    dec a 
   6885 28 50         [12]   88    jr z, descuentoFin
   6887 0C            [ 4]   89    inc c 
   6888 3D            [ 4]   90    dec a 
   6889 28 4C         [12]   91    jr z, descuentoFin
   688B 0C            [ 4]   92    inc c 
   688C 3D            [ 4]   93    dec a 
   688D 28 48         [12]   94    jr z, descuentoFin
   688F 0C            [ 4]   95    inc c 
   6890 3D            [ 4]   96    dec a 
   6891 28 44         [12]   97    jr z, descuentoFin
   6893 0C            [ 4]   98    inc c 
   6894 3D            [ 4]   99    dec a 
   6895 28 40         [12]  100    jr z, descuentoFin
   6897 0C            [ 4]  101    inc c 
   6898 3D            [ 4]  102    dec a 
   6899 28 3C         [12]  103    jr z, descuentoFin
   689B 0C            [ 4]  104    inc c 
   689C 3D            [ 4]  105    dec a 
   689D 28 38         [12]  106    jr z, descuentoFin
   689F 0C            [ 4]  107    inc c 
   68A0 3D            [ 4]  108    dec a 
   68A1 28 34         [12]  109    jr z, descuentoFin
   68A3 14            [ 4]  110    inc d
   68A4 0E 00         [ 7]  111    ld c, #0
   68A6 0D            [ 4]  112    dec c
   68A7 18 00         [12]  113    jr obtenerUnidades2
                            114 
   68A9                     115    obtenerUnidades2:
   68A9 0C            [ 4]  116    inc c 
   68AA 3D            [ 4]  117    dec a 
   68AB 28 2A         [12]  118    jr z, descuentoFin
   68AD 0C            [ 4]  119    inc c 
   68AE 3D            [ 4]  120    dec a 
   68AF 28 26         [12]  121    jr z, descuentoFin
   68B1 0C            [ 4]  122    inc c 
   68B2 3D            [ 4]  123    dec a 
   68B3 28 22         [12]  124    jr z, descuentoFin
   68B5 0C            [ 4]  125    inc c 
   68B6 3D            [ 4]  126    dec a 
   68B7 28 1E         [12]  127    jr z, descuentoFin
   68B9 0C            [ 4]  128    inc c 
...
Hexadecimal [16-Bits]
   ...
   68BA 3D            [ 4]  129    dec a 
   68BB 28 1A         [12]  130    jr z, descuentoFin
   68BD 0C            [ 4]  131    inc c 
   68BE 3D            [ 4]  132    dec a 
   68BF 28 16         [12]  133    jr z, descuentoFin
   68C1 0C            [ 4]  134    inc c 
   68C2 3D            [ 4]  135    dec a 
   68C3 28 12         [12]  136    jr z, descuentoFin
   68C5 0C            [ 4]  137    inc c 
   68C6 3D            [ 4]  138    dec a 
   68C7 28 0E         [12]  139    jr z, descuentoFin
   68C9 0C            [ 4]  140    inc c 
   68CA 3D            [ 4]  141    dec a 
   68CB 28 0A         [12]  142    jr z, descuentoFin
   68CD 0C            [ 4]  143    inc c 
   68CE 3D            [ 4]  144    dec a 
   68CF 28 06         [12]  145    jr z, descuentoFin
   68D1 14            [ 4]  146    inc d
   68D2 0E 00         [ 7]  147    ld c, #0
   68D4 0D            [ 4]  148    dec c
   68D5 18 D2         [12]  149    jr obtenerUnidades2
                            150 
                            151 
                            152 
                            153    
   68D7                     154    descuentoFin:
   68D7 14            [ 4]  155    inc d 
   68D8 15            [ 4]  156    dec d 
   68D9 28 64         [12]  157    jr z, pintarCeroDecenasBucle
   68DB 15            [ 4]  158    dec d 
   68DC 28 5A         [12]  159    jr z, pintarUnoDecenasBucle
   68DE 15            [ 4]  160    dec d 
   68DF 28 50         [12]  161    jr z, pintarDosDecenasBucle
   68E1 15            [ 4]  162    dec d 
   68E2 28 46         [12]  163    jr z, pintarTresDecenasBucle
   68E4 15            [ 4]  164    dec d 
   68E5 28 3C         [12]  165    jr z, pintarCuatroDecenasBucle
   68E7 15            [ 4]  166    dec d 
   68E8 28 32         [12]  167    jr z, pintarCincoDecenasBucle
   68EA 15            [ 4]  168    dec d 
   68EB 28 28         [12]  169    jr z, pintarSeisDecenasBucle
   68ED 15            [ 4]  170    dec d 
   68EE 28 1E         [12]  171    jr z, pintarSieteDecenasBucle
   68F0 15            [ 4]  172    dec d 
   68F1 28 14         [12]  173    jr z, pintarOchoDecenasBucle
   68F3 15            [ 4]  174    dec d
                            175    ;;añadimos centenas
   68F4 28 0A         [12]  176    jr z, pintarNueveDecenasBucle
   68F6 DD 21 55 68   [14]  177     ld ix, #centenas 
   68FA DD 34 00      [23]  178     inc 0(ix)
   68FD 15            [ 4]  179     dec d
   68FE 18 D7         [12]  180    jr descuentoFin
                            181 
                            182 
   6900                     183    pintarNueveDecenasBucle:
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (Zilog Z80 / Hitachi HD64180), page 60.
Hexadecimal [16-Bits]



   6900 C5            [11]  184    push bc
   6901 CD 18 A2      [17]  185    call pintarNueveDecenas2
   6904 C1            [10]  186    pop bc
   6905 18 3F         [12]  187    jr pintarUnidades
                            188 
   6907                     189    pintarOchoDecenasBucle:
   6907 C5            [11]  190    push bc
   6908 CD FF A1      [17]  191    call pintarOchoDecenas2
   690B C1            [10]  192    pop bc
   690C 18 38         [12]  193    jr pintarUnidades
   690E                     194    pintarSieteDecenasBucle:
   690E C5            [11]  195    push bc
   690F CD E6 A1      [17]  196    call pintarSieteDecenas2
   6912 C1            [10]  197    pop bc
   6913 18 31         [12]  198    jr pintarUnidades
   6915                     199    pintarSeisDecenasBucle:
   6915 C5            [11]  200    push bc
   6916 CD CD A1      [17]  201    call pintarSeisDecenas2
   6919 C1            [10]  202    pop bc
   691A 18 2A         [12]  203    jr pintarUnidades
   691C                     204    pintarCincoDecenasBucle:
   691C C5            [11]  205    push bc
   691D CD B4 A1      [17]  206    call pintarCincoDecenas2
   6920 C1            [10]  207    pop bc
   6921 18 23         [12]  208    jr pintarUnidades
   6923                     209    pintarCuatroDecenasBucle:
   6923 C5            [11]  210    push bc
   6924 CD 9B A1      [17]  211    call pintarCuatroDecenas2
   6927 C1            [10]  212    pop bc
   6928 18 1C         [12]  213    jr pintarUnidades
   692A                     214    pintarTresDecenasBucle:
   692A C5            [11]  215    push bc
   692B CD 82 A1      [17]  216    call pintarTresDecenas2
   692E C1            [10]  217    pop bc
   692F 18 15         [12]  218    jr pintarUnidades
   6931                     219    pintarDosDecenasBucle:
   6931 C5            [11]  220    push bc
   6932 CD 69 A1      [17]  221    call pintarDosDecenas2
   6935 C1            [10]  222    pop bc
   6936 18 0E         [12]  223    jr pintarUnidades
   6938                     224    pintarUnoDecenasBucle:
   6938 C5            [11]  225    push bc
   6939 CD 50 A1      [17]  226    call pintarUnoDecenas2
   693C C1            [10]  227    pop bc
   693D 18 07         [12]  228    jr pintarUnidades
   693F                     229    pintarCeroDecenasBucle:
   693F C5            [11]  230    push bc
   6940 CD 37 A1      [17]  231    call pintarCeroDecenas2
   6943 C1            [10]  232    pop bc
   6944 18 00         [12]  233    jr pintarUnidades
                            234 
                            235 
   6946                     236    pintarUnidades:
   6946 0C            [ 4]  237    inc c 
   6947 0D            [ 4]  238    dec c 
...
Hexadecimal [16-Bits]
   ...
   6948 28 45         [12]  239    jr z, pintarCeroUnidadesBucle
   694A 0D            [ 4]  240    dec c 
   694B 28 3D         [12]  241    jr z, pintarUnoUnidadesBucle
   694D 0D            [ 4]  242    dec c 
   694E 28 35         [12]  243    jr z, pintarDosUnidadesBucle
   6950 0D            [ 4]  244    dec c 
   6951 28 2D         [12]  245    jr z, pintarTresUnidadesBucle
   6953 0D            [ 4]  246    dec c 
   6954 28 25         [12]  247    jr z, pintarCuatroUnidadesBucle
   6956 0D            [ 4]  248    dec c 
   6957 28 1D         [12]  249    jr z, pintarCincoUnidadesBucle
   6959 0D            [ 4]  250    dec c 
   695A 28 15         [12]  251    jr z, pintarSeisUnidadesBucle
   695C 0D            [ 4]  252    dec c 
   695D 28 0D         [12]  253    jr z, pintarSieteUnidadesBucle
   695F 0D            [ 4]  254    dec c 
   6960 28 05         [12]  255    jr z, pintarOchoUnidadesBucle
   6962 CD 20 68      [17]  256    call pintarNueveUnidades2
   6965 18 2D         [12]  257    jr finscore
                            258 
   6967                     259    pintarOchoUnidadesBucle:
   6967 CD 07 68      [17]  260    call pintarOchoUnidades2
   696A 18 28         [12]  261    jr finscore
   696C                     262    pintarSieteUnidadesBucle:
   696C CD EE 67      [17]  263    call pintarSieteUnidades2
   696F 18 23         [12]  264    jr finscore
   6971                     265    pintarSeisUnidadesBucle:
   6971 CD D5 67      [17]  266    call pintarSeisUnidades2
   6974 18 1E         [12]  267    jr finscore
   6976                     268    pintarCincoUnidadesBucle:
   6976 CD BC 67      [17]  269    call pintarCincoUnidades2
   6979 18 19         [12]  270    jr finscore
   697B                     271    pintarCuatroUnidadesBucle:
   697B CD A3 67      [17]  272    call pintarCuatroUnidades2
   697E 18 14         [12]  273    jr finscore
   6980                     274    pintarTresUnidadesBucle:
   6980 CD 8A 67      [17]  275    call pintarTresUnidades2
   6983 18 0F         [12]  276    jr finscore
   6985                     277    pintarDosUnidadesBucle:
   6985 CD 71 67      [17]  278    call pintarDosUnidades2
   6988 18 0A         [12]  279    jr finscore
   698A                     280    pintarUnoUnidadesBucle:
   698A CD 58 67      [17]  281    call pintarUnoUnidades2
   698D 18 05         [12]  282    jr finscore
   698F                     283    pintarCeroUnidadesBucle:
   698F CD 3F 67      [17]  284    call pintarCeroUnidades2
   6992 18 00         [12]  285    jr finscore
                            286 
                            287 
   6994                     288    finscore:
                            289 
   6994 DD 21 55 68   [14]  290    ld ix, #centenas
   6998 DD 34 00      [23]  291    inc 0(ix) 
   699B DD 35 00      [23]  292    dec 0(ix)
   699E CA D4 69      [10]  293    jp z, ceroCentenas
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (Zilog Z80 / Hitachi HD64180), page 62.
Hexadecimal [16-Bits]



   69A1 DD 35 00      [23]  294    dec 0(ix)
   69A4 CA EF 69      [10]  295    jp z, unoCentenas
   69A7 DD 35 00      [23]  296    dec 0(ix)
   69AA CA 0A 6A      [10]  297    jp z, dosCentenas
   69AD DD 35 00      [23]  298    dec 0(ix)
   69B0 CA 25 6A      [10]  299    jp z, tresCentenas
   69B3 DD 35 00      [23]  300    dec 0(ix)
   69B6 CA 40 6A      [10]  301    jp z, cuatroCentenas
   69B9 DD 35 00      [23]  302    dec 0(ix)
   69BC CA 5B 6A      [10]  303    jp z, cincoCentenas
   69BF DD 35 00      [23]  304    dec 0(ix)
   69C2 CA 76 6A      [10]  305    jp z, seisCentenas
   69C5 DD 35 00      [23]  306    dec 0(ix)
   69C8 CA 91 6A      [10]  307    jp z, sieteCentenas
   69CB DD 35 00      [23]  308    dec 0(ix)
   69CE CA AC 6A      [10]  309    jp z, ochoCentenas
   69D1 C3 C7 6A      [10]  310    jp  nueveCentenas
                            311 
   69D4                     312     ceroCentenas:
   69D4 16 02         [ 7]  313     ld    d, #2         ;; D = Background PEN (0)
   69D6 1E 03         [ 7]  314    ld    e, #3         ;; E = Foreground PEN (3) ;;3 rojo, 2 azul, 1 amarillo, 0 fondo, mas de 3 multicolor
                            315 
   69D8 CD 88 B0      [17]  316    call cpct_setDrawCharM1_asm   ;; Set draw char colours
                            317 
                            318    ;; Calculate a video-memory location for printing a string
   69DB 11 00 C0      [10]  319    ld   de, #CPCT_VMEM_START_ASM ;; DE = Pointer to start of the screen
   69DE 06 BE         [ 7]  320    ld    b, #190                  ;; B = y coordinate (24 = 0x18)
   69E0 0E 43         [ 7]  321    ld    c, #67                 ;; C = x coordinate (16 = 0x10)
                            322 
   69E2 CD 6C B0      [17]  323    call cpct_getScreenPtr_asm    ;; Calculate video memory location and return it in HL
                            324 
                            325    ;; Print the string in video memory
                            326    ;; HL already points to video memory, as it is the return
                            327    ;; value from cpct_getScreenPtr_asm
   69E5 FD 21 41 68   [14]  328    ld   iy, #Escribir0    ;; IY = Pointer to the string 
                            329    
   69E9 CD 63 AE      [17]  330    call cpct_drawStringM1_asm
                            331 
   69EC C3 E2 6A      [10]  332    jp pintarCeros
   69EF                     333    unoCentenas:
   69EF 16 02         [ 7]  334     ld    d, #2         ;; D = Background PEN (0)
   69F1 1E 03         [ 7]  335    ld    e, #3         ;; E = Foreground PEN (3) ;;3 rojo, 2 azul, 1 amarillo, 0 fondo, mas de 3 multicolor
                            336 
   69F3 CD 88 B0      [17]  337    call cpct_setDrawCharM1_asm   ;; Set draw char colours
                            338 
                            339    ;; Calculate a video-memory location for printing a string
   69F6 11 00 C0      [10]  340    ld   de, #CPCT_VMEM_START_ASM ;; DE = Pointer to start of the screen
   69F9 06 BE         [ 7]  341    ld    b, #190                  ;; B = y coordinate (24 = 0x18)
   69FB 0E 43         [ 7]  342    ld    c, #67                 ;; C = x coordinate (16 = 0x10)
                            343 
   69FD CD 6C B0      [17]  344    call cpct_getScreenPtr_asm    ;; Calculate video memory location and return it in HL
                            345 
                            346    ;; Print the string in video memory
                            347    ;; HL already points to video memory, as it is the return
                            348    ;; value from cpct_getScreenPtr_asm
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (Zilog Z80 / Hitachi HD64180), page 63.
Hexadecimal [16-Bits]



   6A00 FD 21 43 68   [14]  349    ld   iy, #Escribir1    ;; IY = Pointer to the string 
                            350    
   6A04 CD 63 AE      [17]  351    call cpct_drawStringM1_asm
                            352 
   6A07 C3 E2 6A      [10]  353    jp pintarCeros
                            354 
   6A0A                     355    dosCentenas:
   6A0A 16 02         [ 7]  356     ld    d, #2         ;; D = Background PEN (0)
   6A0C 1E 03         [ 7]  357    ld    e, #3         ;; E = Foreground PEN (3) ;;3 rojo, 2 azul, 1 amarillo, 0 fondo, mas de 3 multicolor
                            358 
   6A0E CD 88 B0      [17]  359    call cpct_setDrawCharM1_asm   ;; Set draw char colours
                            360 
                            361    ;; Calculate a video-memory location for printing a string
   6A11 11 00 C0      [10]  362    ld   de, #CPCT_VMEM_START_ASM ;; DE = Pointer to start of the screen
   6A14 06 BE         [ 7]  363    ld    b, #190                  ;; B = y coordinate (24 = 0x18)
   6A16 0E 43         [ 7]  364    ld    c, #67                 ;; C = x coordinate (16 = 0x10)
                            365 
   6A18 CD 6C B0      [17]  366    call cpct_getScreenPtr_asm    ;; Calculate video memory location and return it in HL
                            367 
                            368    ;; Print the string in video memory
                            369    ;; HL already points to video memory, as it is the return
                            370    ;; value from cpct_getScreenPtr_asm
   6A1B FD 21 45 68   [14]  371    ld   iy, #Escribir2    ;; IY = Pointer to the string 
                            372    
   6A1F CD 63 AE      [17]  373    call cpct_drawStringM1_asm
                            374 
   6A22 C3 E2 6A      [10]  375    jp pintarCeros
                            376 
   6A25                     377    tresCentenas:
   6A25 16 02         [ 7]  378     ld    d, #2         ;; D = Background PEN (0)
   6A27 1E 03         [ 7]  379    ld    e, #3         ;; E = Foreground PEN (3) ;;3 rojo, 2 azul, 1 amarillo, 0 fondo, mas de 3 multicolor
                            380 
   6A29 CD 88 B0      [17]  381    call cpct_setDrawCharM1_asm   ;; Set draw char colours
                            382 
                            383    ;; Calculate a video-memory location for printing a string
   6A2C 11 00 C0      [10]  384    ld   de, #CPCT_VMEM_START_ASM ;; DE = Pointer to start of the screen
   6A2F 06 BE         [ 7]  385    ld    b, #190                  ;; B = y coordinate (24 = 0x18)
   6A31 0E 43         [ 7]  386    ld    c, #67                 ;; C = x coordinate (16 = 0x10)
                            387 
   6A33 CD 6C B0      [17]  388    call cpct_getScreenPtr_asm    ;; Calculate video memory location and return it in HL
                            389 
                            390    ;; Print the string in video memory
                            391    ;; HL already points to video memory, as it is the return
                            392    ;; value from cpct_getScreenPtr_asm
   6A36 FD 21 47 68   [14]  393    ld   iy, #Escribir3    ;; IY = Pointer to the string 
                            394    
   6A3A CD 63 AE      [17]  395    call cpct_drawStringM1_asm
                            396 
   6A3D C3 E2 6A      [10]  397    jp pintarCeros
                            398 
   6A40                     399     cuatroCentenas:
   6A40 16 02         [ 7]  400     ld    d, #2         ;; D = Background PEN (0)
   6A42 1E 03         [ 7]  401    ld    e, #3         ;; E = Foreground PEN (3) ;;3 rojo, 2 azul, 1 amarillo, 0 fondo, mas de 3 multicolor
                            402 
   6A44 CD 88 B0      [17]  403    call cpct_setDrawCharM1_asm   ;; Set draw char colours
...
Hexadecimal [16-Bits]
                            ...
                            404 
                            405    ;; Calculate a video-memory location for printing a string
   6A47 11 00 C0      [10]  406    ld   de, #CPCT_VMEM_START_ASM ;; DE = Pointer to start of the screen
   6A4A 06 BE         [ 7]  407    ld    b, #190                  ;; B = y coordinate (24 = 0x18)
   6A4C 0E 43         [ 7]  408    ld    c, #67                 ;; C = x coordinate (16 = 0x10)
                            409 
   6A4E CD 6C B0      [17]  410    call cpct_getScreenPtr_asm    ;; Calculate video memory location and return it in HL
                            411 
                            412    ;; Print the string in video memory
                            413    ;; HL already points to video memory, as it is the return
                            414    ;; value from cpct_getScreenPtr_asm
   6A51 FD 21 49 68   [14]  415    ld   iy, #Escribir4    ;; IY = Pointer to the string 
                            416    
   6A55 CD 63 AE      [17]  417    call cpct_drawStringM1_asm
                            418 
   6A58 C3 E2 6A      [10]  419    jp pintarCeros
                            420 
   6A5B                     421    cincoCentenas:
   6A5B 16 02         [ 7]  422     ld    d, #2         ;; D = Background PEN (0)
   6A5D 1E 03         [ 7]  423    ld    e, #3         ;; E = Foreground PEN (3) ;;3 rojo, 2 azul, 1 amarillo, 0 fondo, mas de 3 multicolor
                            424 
   6A5F CD 88 B0      [17]  425    call cpct_setDrawCharM1_asm   ;; Set draw char colours
                            426 
                            427    ;; Calculate a video-memory location for printing a string
   6A62 11 00 C0      [10]  428    ld   de, #CPCT_VMEM_START_ASM ;; DE = Pointer to start of the screen
   6A65 06 BE         [ 7]  429    ld    b, #190                  ;; B = y coordinate (24 = 0x18)
   6A67 0E 43         [ 7]  430    ld    c, #67                 ;; C = x coordinate (16 = 0x10)
                            431 
   6A69 CD 6C B0      [17]  432    call cpct_getScreenPtr_asm    ;; Calculate video memory location and return it in HL
                            433 
                            434    ;; Print the string in video memory
                            435    ;; HL already points to video memory, as it is the return
                            436    ;; value from cpct_getScreenPtr_asm
   6A6C FD 21 4B 68   [14]  437    ld   iy, #Escribir5    ;; IY = Pointer to the string 
                            438    
   6A70 CD 63 AE      [17]  439    call cpct_drawStringM1_asm
                            440 
   6A73 C3 E2 6A      [10]  441    jp pintarCeros
                            442 
   6A76                     443     seisCentenas:
   6A76 16 02         [ 7]  444     ld    d, #2         ;; D = Background PEN (0)
   6A78 1E 03         [ 7]  445    ld    e, #3         ;; E = Foreground PEN (3) ;;3 rojo, 2 azul, 1 amarillo, 0 fondo, mas de 3 multicolor
                            446 
   6A7A CD 88 B0      [17]  447    call cpct_setDrawCharM1_asm   ;; Set draw char colours
                            448 
                            449    ;; Calculate a video-memory location for printing a string
   6A7D 11 00 C0      [10]  450    ld   de, #CPCT_VMEM_START_ASM ;; DE = Pointer to start of the screen
   6A80 06 BE         [ 7]  451    ld    b, #190                  ;; B = y coordinate (24 = 0x18)
   6A82 0E 43         [ 7]  452    ld    c, #67                 ;; C = x coordinate (16 = 0x10)
                            453 
   6A84 CD 6C B0      [17]  454    call cpct_getScreenPtr_asm    ;; Calculate video memory location and return it in HL
                            455 
                            456    ;; Print the string in video memory
                            457    ;; HL already points to video memory, as it is the return
                            458    ;; value from cpct_getScreenPtr_asm
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (Zilog Z80 / Hitachi HD64180), page 65.
Hexadecimal [16-Bits]



   6A87 FD 21 4D 68   [14]  459    ld   iy, #Escribir6    ;; IY = Pointer to the string 
                            460    
   6A8B CD 63 AE      [17]  461    call cpct_drawStringM1_asm
                            462 
   6A8E C3 E2 6A      [10]  463    jp pintarCeros
                            464 
   6A91                     465    sieteCentenas:
   6A91 16 02         [ 7]  466     ld    d, #2         ;; D = Background PEN (0)
   6A93 1E 03         [ 7]  467    ld    e, #3         ;; E = Foreground PEN (3) ;;3 rojo, 2 azul, 1 amarillo, 0 fondo, mas de 3 multicolor
                            468 
   6A95 CD 88 B0      [17]  469    call cpct_setDrawCharM1_asm   ;; Set draw char colours
                            470 
                            471    ;; Calculate a video-memory location for printing a string
   6A98 11 00 C0      [10]  472    ld   de, #CPCT_VMEM_START_ASM ;; DE = Pointer to start of the screen
   6A9B 06 BE         [ 7]  473    ld    b, #190                  ;; B = y coordinate (24 = 0x18)
   6A9D 0E 43         [ 7]  474    ld    c, #67                 ;; C = x coordinate (16 = 0x10)
                            475 
   6A9F CD 6C B0      [17]  476    call cpct_getScreenPtr_asm    ;; Calculate video memory location and return it in HL
                            477 
                            478    ;; Print the string in video memory
                            479    ;; HL already points to video memory, as it is the return
                            480    ;; value from cpct_getScreenPtr_asm
   6AA2 FD 21 4F 68   [14]  481    ld   iy, #Escribir7    ;; IY = Pointer to the string 
                            482    
   6AA6 CD 63 AE      [17]  483    call cpct_drawStringM1_asm
                            484 
   6AA9 C3 E2 6A      [10]  485    jp pintarCeros
                            486 
   6AAC                     487    ochoCentenas:
   6AAC 16 02         [ 7]  488     ld    d, #2         ;; D = Background PEN (0)
   6AAE 1E 03         [ 7]  489    ld    e, #3         ;; E = Foreground PEN (3) ;;3 rojo, 2 azul, 1 amarillo, 0 fondo, mas de 3 multicolor
                            490 
   6AB0 CD 88 B0      [17]  491    call cpct_setDrawCharM1_asm   ;; Set draw char colours
                            492 
                            493    ;; Calculate a video-memory location for printing a string
   6AB3 11 00 C0      [10]  494    ld   de, #CPCT_VMEM_START_ASM ;; DE = Pointer to start of the screen
   6AB6 06 BE         [ 7]  495    ld    b, #190                  ;; B = y coordinate (24 = 0x18)
   6AB8 0E 43         [ 7]  496    ld    c, #67                 ;; C = x coordinate (16 = 0x10)
                            497 
   6ABA CD 6C B0      [17]  498    call cpct_getScreenPtr_asm    ;; Calculate video memory location and return it in HL
                            499 
                            500    ;; Print the string in video memory
                            501    ;; HL already points to video memory, as it is the return
                            502    ;; value from cpct_getScreenPtr_asm
   6ABD FD 21 51 68   [14]  503    ld   iy, #Escribir8    ;; IY = Pointer to the string 
                            504    
   6AC1 CD 63 AE      [17]  505    call cpct_drawStringM1_asm
                            506 
   6AC4 C3 E2 6A      [10]  507    jp pintarCeros
                            508 
   6AC7                     509    nueveCentenas:
   6AC7 16 02         [ 7]  510     ld    d, #2         ;; D = Background PEN (0)
   6AC9 1E 03         [ 7]  511    ld    e, #3         ;; E = Foreground PEN (3) ;;3 rojo, 2 azul, 1 amarillo, 0 fondo, mas de 3 multicolor
                            512 
   6ACB CD 88 B0      [17]  513    call cpct_setDrawCharM1_asm   ;; Set draw char colours
...
Hexadecimal [16-Bits]
                            ...
                            514 
                            515    ;; Calculate a video-memory location for printing a string
   6ACE 11 00 C0      [10]  516    ld   de, #CPCT_VMEM_START_ASM ;; DE = Pointer to start of the screen
   6AD1 06 BE         [ 7]  517    ld    b, #190                  ;; B = y coordinate (24 = 0x18)
   6AD3 0E 43         [ 7]  518    ld    c, #67                 ;; C = x coordinate (16 = 0x10)
                            519 
   6AD5 CD 6C B0      [17]  520    call cpct_getScreenPtr_asm    ;; Calculate video memory location and return it in HL
                            521 
                            522    ;; Print the string in video memory
                            523    ;; HL already points to video memory, as it is the return
                            524    ;; value from cpct_getScreenPtr_asm
   6AD8 FD 21 53 68   [14]  525    ld   iy, #Escribir9    ;; IY = Pointer to the string 
                            526    
   6ADC CD 63 AE      [17]  527    call cpct_drawStringM1_asm
                            528 
   6ADF C3 E2 6A      [10]  529    jp pintarCeros
                            530 
                            531 
                            532 
                            533 
                            ...
                            536 
                            537 
   6AE2                     538     pintarCeros:
                            539    ;;///Pintar 3 Ceros mas al final
                            540 
   6AE2 16 02         [ 7]  541    ld    d, #2         ;; D = Background PEN (0)
   6AE4 1E 03         [ 7]  542    ld    e, #3         ;; E = Foreground PEN (3) ;;3 rojo, 2 azul, 1 amarillo, 0 fondo, mas de 3 multicolor
                            543 
   6AE6 CD 88 B0      [17]  544    call cpct_setDrawCharM1_asm   ;; Set draw char colours
                            545 
                            546    ;; Calculate a video-memory location for printing a string
   6AE9 11 00 C0      [10]  547    ld   de, #CPCT_VMEM_START_ASM ;; DE = Pointer to start of the screen
   6AEC 06 BE         [ 7]  548    ld    b, #190                  ;; B = y coordinate (24 = 0x18)
   6AEE 0E 49         [ 7]  549    ld    c, #73                 ;; C = x coordinate (16 = 0x10)
                            550 
   6AF0 CD 6C B0      [17]  551    call cpct_getScreenPtr_asm    ;; Calculate video memory location and return it in HL
                            552 
                            553    ;; Print the string in video memory
                            554    ;; HL already points to video memory, as it is the return
                            555    ;; value from cpct_getScreenPtr_asm
   6AF3 FD 21 41 68   [14]  556    ld   iy, #Escribir0    ;; IY = Pointer to the string 
                            557    
   6AF7 CD 63 AE      [17]  558    call cpct_drawStringM1_asm
                            559 
   6AFA 16 02         [ 7]  560    ld    d, #2         ;; D = Background PEN (0)
   6AFC 1E 03         [ 7]  561    ld    e, #3        ;; E = Foreground PEN (3) ;;3 rojo, 2 azul, 1 amarillo, 0 fondo, mas de 3 multicolor
                            562 
   6AFE CD 88 B0      [17]  563    call cpct_setDrawCharM1_asm   ;; Set draw char colours
                            564 
                            565    ;; Calculate a video-memory location for printing a string
   6B01 11 00 C0      [10]  566    ld   de, #CPCT_VMEM_START_ASM ;; DE = Pointer to start of the screen
   6B04 06 BE         [ 7]  567    ld    b, #190                  ;; B = y coordinate (24 = 0x18)
   6B06 0E 4B         [ 7]  568    ld    c, #75                 ;; C = x coordinate (16 = 0x10)
...
Hexadecimal [16-Bits]
                            ...
                            569 
   6B08 CD 6C B0      [17]  570    call cpct_getScreenPtr_asm    ;; Calculate video memory location and return it in HL
                            571 
                            572    ;; Print the string in video memory
                            573    ;; HL already points to video memory, as it is the return
                            574    ;; value from cpct_getScreenPtr_asm
   6B0B FD 21 41 68   [14]  575    ld   iy, #Escribir0    ;; IY = Pointer to the string 
                            576    
   6B0F CD 63 AE      [17]  577    call cpct_drawStringM1_asm
                            578 
   6B12 16 02         [ 7]  579    ld    d, #2         ;; D = Background PEN (0)
   6B14 1E 03         [ 7]  580    ld    e, #3         ;; E = Foreground PEN (3) ;;3 rojo, 2 azul, 1 amarillo, 0 fondo, mas de 3 multicolor
                            581 
   6B16 CD 88 B0      [17]  582    call cpct_setDrawCharM1_asm   ;; Set draw char colours
                            583 
                            584    ;; Calculate a video-memory location for printing a string
   6B19 11 00 C0      [10]  585    ld   de, #CPCT_VMEM_START_ASM ;; DE = Pointer to start of the screen
   6B1C 06 BE         [ 7]  586    ld    b, #190                  ;; B = y coordinate (24 = 0x18)
   6B1E 0E 4D         [ 7]  587    ld    c, #77                 ;; C = x coordinate (16 = 0x10)
                            588 
   6B20 CD 6C B0      [17]  589    call cpct_getScreenPtr_asm    ;; Calculate video memory location and return it in HL
                            590 
                            591    ;; Print the string in video memory
                            592    ;; HL already points to video memory, as it is the return
                            593    ;; value from cpct_getScreenPtr_asm
   6B23 FD 21 41 68   [14]  594    ld   iy, #Escribir0    ;; IY = Pointer to the string 
                            595    
   6B27 CD 63 AE      [17]  596    call cpct_drawStringM1_asm
                            597 
   6B2A C9            [10]  598    ret
