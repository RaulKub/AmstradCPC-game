...
Hexadecimal [16-Bits]
   ...
   672B 30 00                19 Escribir0: .asciz "0"
   672D 31 00                20 Escribir1: .asciz "1"
   672F 32 00                21 Escribir2: .asciz "2"
   6731 33 00                22 Escribir3: .asciz "3"
   6733 34 00                23 Escribir4: .asciz "4"
   6735 35 00                24 Escribir5: .asciz "5"
   6737 36 00                25 Escribir6: .asciz "6"
   6739 37 00                26 Escribir7: .asciz "7"
   673B 38 00                27 Escribir8: .asciz "8"
   673D 39 00                28 Escribir9: .asciz "9"
                             29 
                             30 
   673F                      31    pintarCeroUnidades2::
   673F 16 02         [ 7]   32     ld    d, #2         ;; D = Background PEN (0)
   6741 1E 03         [ 7]   33    ld    e, #3         ;; E = Foreground PEN (3) ;;3 rojo, 2 azul, 1 amarillo, 0 fondo, mas de 3 multicolor
                             34 
   6743 CD 88 B0      [17]   35    call cpct_setDrawCharM1_asm   ;; Set draw char colours
                             36 
                             37    ;; Calculate a video-memory location for printing a string
   6746 11 00 C0      [10]   38    ld   de, #CPCT_VMEM_START_ASM ;; DE = Pointer to start of the screen
   6749 06 BE         [ 7]   39    ld    b, #190                  ;; B = y coordinate (24 = 0x18)
   674B 0E 47         [ 7]   40    ld    c, #71                 ;; C = x coordinate (16 = 0x10)
                             41 
   674D CD 6C B0      [17]   42    call cpct_getScreenPtr_asm    ;; Calculate video memory location and return it in HL
                             43 
                             44    ;; Print the string in video memory
                             45    ;; HL already points to video memory, as it is the return
                             46    ;; value from cpct_getScreenPtr_asm
   6750 FD 21 2B 67   [14]   47    ld   iy, #Escribir0    ;; IY = Pointer to the string 
                             48    
   6754 CD 63 AE      [17]   49    call cpct_drawStringM1_asm
   6757 C9            [10]   50    ret
                             51 
   6758                      52    pintarUnoUnidades2::
   6758 16 02         [ 7]   53     ld    d, #2         ;; D = Background PEN (0)
   675A 1E 03         [ 7]   54    ld    e, #3         ;; E = Foreground PEN (3) ;;3 rojo, 2 azul, 1 amarillo, 0 fondo, mas de 3 multicolor
                             55 
   675C CD 88 B0      [17]   56    call cpct_setDrawCharM1_asm   ;; Set draw char colours
                             57 
                             58    ;; Calculate a video-memory location for printing a string
   675F 11 00 C0      [10]   59    ld   de, #CPCT_VMEM_START_ASM ;; DE = Pointer to start of the screen
   6762 06 BE         [ 7]   60    ld    b, #190                  ;; B = y coordinate (24 = 0x18)
   6764 0E 47         [ 7]   61    ld    c, #71                 ;; C = x coordinate (16 = 0x10)
                             62 
   6766 CD 6C B0      [17]   63    call cpct_getScreenPtr_asm    ;; Calculate video memory location and return it in HL
                             64 
                             65    ;; Print the string in video memory
                             66    ;; HL already points to video memory, as it is the return
                             67    ;; value from cpct_getScreenPtr_asm
   6769 FD 21 2D 67   [14]   68    ld   iy, #Escribir1    ;; IY = Pointer to the string 
                             69    
   676D CD 63 AE      [17]   70    call cpct_drawStringM1_asm
   6770 C9            [10]   71    ret
                             72 
   6771                      73    pintarDosUnidades2::
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (Zilog Z80 / Hitachi HD64180), page 57.
Hexadecimal [16-Bits]



   6771 16 02         [ 7]   74     ld    d, #2         ;; D = Background PEN (0)
   6773 1E 03         [ 7]   75    ld    e, #3         ;; E = Foreground PEN (3) ;;3 rojo, 2 azul, 1 amarillo, 0 fondo, mas de 3 multicolor
                             76 
   6775 CD 88 B0      [17]   77    call cpct_setDrawCharM1_asm   ;; Set draw char colours
                             78 
                             79    ;; Calculate a video-memory location for printing a string
   6778 11 00 C0      [10]   80    ld   de, #CPCT_VMEM_START_ASM ;; DE = Pointer to start of the screen
   677B 06 BE         [ 7]   81    ld    b, #190                  ;; B = y coordinate (24 = 0x18)
   677D 0E 47         [ 7]   82    ld    c, #71                 ;; C = x coordinate (16 = 0x10)
                             83 
   677F CD 6C B0      [17]   84    call cpct_getScreenPtr_asm    ;; Calculate video memory location and return it in HL
                             85 
                             86    ;; Print the string in video memory
                             87    ;; HL already points to video memory, as it is the return
                             88    ;; value from cpct_getScreenPtr_asm
   6782 FD 21 2F 67   [14]   89    ld   iy, #Escribir2    ;; IY = Pointer to the string 
                             90    
   6786 CD 63 AE      [17]   91    call cpct_drawStringM1_asm
   6789 C9            [10]   92    ret
   678A                      93    pintarTresUnidades2::
   678A 16 02         [ 7]   94     ld    d, #2         ;; D = Background PEN (0)
   678C 1E 03         [ 7]   95    ld    e, #3         ;; E = Foreground PEN (3) ;;3 rojo, 2 azul, 1 amarillo, 0 fondo, mas de 3 multicolor
                             96 
   678E CD 88 B0      [17]   97    call cpct_setDrawCharM1_asm   ;; Set draw char colours
                             98 
                             99    ;; Calculate a video-memory location for printing a string
   6791 11 00 C0      [10]  100    ld   de, #CPCT_VMEM_START_ASM ;; DE = Pointer to start of the screen
   6794 06 BE         [ 7]  101    ld    b, #190                  ;; B = y coordinate (24 = 0x18)
   6796 0E 47         [ 7]  102    ld    c, #71                 ;; C = x coordinate (16 = 0x10)
                            103 
   6798 CD 6C B0      [17]  104    call cpct_getScreenPtr_asm    ;; Calculate video memory location and return it in HL
                            105 
                            106    ;; Print the string in video memory
                            107    ;; HL already points to video memory, as it is the return
                            108    ;; value from cpct_getScreenPtr_asm
   679B FD 21 31 67   [14]  109    ld   iy, #Escribir3    ;; IY = Pointer to the string 
                            110    
   679F CD 63 AE      [17]  111    call cpct_drawStringM1_asm
   67A2 C9            [10]  112    ret
   67A3                     113    pintarCuatroUnidades2::
   67A3 16 02         [ 7]  114     ld    d, #2         ;; D = Background PEN (0)
   67A5 1E 03         [ 7]  115    ld    e, #3         ;; E = Foreground PEN (3) ;;3 rojo, 2 azul, 1 amarillo, 0 fondo, mas de 3 multicolor
                            116 
   67A7 CD 88 B0      [17]  117    call cpct_setDrawCharM1_asm   ;; Set draw char colours
                            118 
                            119    ;; Calculate a video-memory location for printing a string
   67AA 11 00 C0      [10]  120    ld   de, #CPCT_VMEM_START_ASM ;; DE = Pointer to start of the screen
   67AD 06 BE         [ 7]  121    ld    b, #190                  ;; B = y coordinate (24 = 0x18)
   67AF 0E 47         [ 7]  122    ld    c, #71                 ;; C = x coordinate (16 = 0x10)
                            123 
   67B1 CD 6C B0      [17]  124    call cpct_getScreenPtr_asm    ;; Calculate video memory location and return it in HL
                            125 
                            126    ;; Print the string in video memory
                            127    ;; HL already points to video memory, as it is the return
                            128    ;; value from cpct_getScreenPtr_asm
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (Zilog Z80 / Hitachi HD64180), page 58.
Hexadecimal [16-Bits]



   67B4 FD 21 33 67   [14]  129    ld   iy, #Escribir4    ;; IY = Pointer to the string 
                            130    
   67B8 CD 63 AE      [17]  131    call cpct_drawStringM1_asm
   67BB C9            [10]  132    ret
   67BC                     133    pintarCincoUnidades2::
   67BC 16 02         [ 7]  134     ld    d, #2         ;; D = Background PEN (0)
   67BE 1E 03         [ 7]  135    ld    e, #3         ;; E = Foreground PEN (3) ;;3 rojo, 2 azul, 1 amarillo, 0 fondo, mas de 3 multicolor
                            136 
   67C0 CD 88 B0      [17]  137    call cpct_setDrawCharM1_asm   ;; Set draw char colours
                            138 
                            139    ;; Calculate a video-memory location for printing a string
   67C3 11 00 C0      [10]  140    ld   de, #CPCT_VMEM_START_ASM ;; DE = Pointer to start of the screen
   67C6 06 BE         [ 7]  141    ld    b, #190                  ;; B = y coordinate (24 = 0x18)
   67C8 0E 47         [ 7]  142    ld    c, #71                 ;; C = x coordinate (16 = 0x10)
                            143 
   67CA CD 6C B0      [17]  144    call cpct_getScreenPtr_asm    ;; Calculate video memory location and return it in HL
                            145 
                            146    ;; Print the string in video memory
                            147    ;; HL already points to video memory, as it is the return
                            148    ;; value from cpct_getScreenPtr_asm
   67CD FD 21 35 67   [14]  149    ld   iy, #Escribir5    ;; IY = Pointer to the string 
                            150    
   67D1 CD 63 AE      [17]  151    call cpct_drawStringM1_asm
   67D4 C9            [10]  152    ret
   67D5                     153    pintarSeisUnidades2::
   67D5 16 02         [ 7]  154     ld    d, #2         ;; D = Background PEN (0)
   67D7 1E 03         [ 7]  155    ld    e, #3         ;; E = Foreground PEN (3) ;;3 rojo, 2 azul, 1 amarillo, 0 fondo, mas de 3 multicolor
                            156 
   67D9 CD 88 B0      [17]  157    call cpct_setDrawCharM1_asm   ;; Set draw char colours
                            158 
                            159    ;; Calculate a video-memory location for printing a string
   67DC 11 00 C0      [10]  160    ld   de, #CPCT_VMEM_START_ASM ;; DE = Pointer to start of the screen
   67DF 06 BE         [ 7]  161    ld    b, #190                  ;; B = y coordinate (24 = 0x18)
   67E1 0E 47         [ 7]  162    ld    c, #71                 ;; C = x coordinate (16 = 0x10)
                            163 
   67E3 CD 6C B0      [17]  164    call cpct_getScreenPtr_asm    ;; Calculate video memory location and return it in HL
                            165 
                            166    ;; Print the string in video memory
                            167    ;; HL already points to video memory, as it is the return
                            168    ;; value from cpct_getScreenPtr_asm
   67E6 FD 21 37 67   [14]  169    ld   iy, #Escribir6    ;; IY = Pointer to the string 
                            170    
   67EA CD 63 AE      [17]  171    call cpct_drawStringM1_asm
   67ED C9            [10]  172    ret
   67EE                     173    pintarSieteUnidades2::
   67EE 16 02         [ 7]  174     ld    d, #2         ;; D = Background PEN (0)
   67F0 1E 03         [ 7]  175    ld    e, #3         ;; E = Foreground PEN (3) ;;3 rojo, 2 azul, 1 amarillo, 0 fondo, mas de 3 multicolor
                            176 
   67F2 CD 88 B0      [17]  177    call cpct_setDrawCharM1_asm   ;; Set draw char colours
                            178 
                            179    ;; Calculate a video-memory location for printing a string
   67F5 11 00 C0      [10]  180    ld   de, #CPCT_VMEM_START_ASM ;; DE = Pointer to start of the screen
   67F8 06 BE         [ 7]  181    ld    b, #190                  ;; B = y coordinate (24 = 0x18)
   67FA 0E 47         [ 7]  182    ld    c, #71                 ;; C = x coordinate (16 = 0x10)
                            183 
...
Hexadecimal [16-Bits]
   ...
   67FC CD 6C B0      [17]  184    call cpct_getScreenPtr_asm    ;; Calculate video memory location and return it in HL
                            185 
                            186    ;; Print the string in video memory
                            187    ;; HL already points to video memory, as it is the return
                            188    ;; value from cpct_getScreenPtr_asm
   67FF FD 21 39 67   [14]  189    ld   iy, #Escribir7    ;; IY = Pointer to the string 
                            190    
   6803 CD 63 AE      [17]  191    call cpct_drawStringM1_asm
   6806 C9            [10]  192    ret
   6807                     193    pintarOchoUnidades2::
   6807 16 02         [ 7]  194     ld    d, #2         ;; D = Background PEN (0)
   6809 1E 03         [ 7]  195    ld    e, #3         ;; E = Foreground PEN (3) ;;3 rojo, 2 azul, 1 amarillo, 0 fondo, mas de 3 multicolor
                            196 
   680B CD 88 B0      [17]  197    call cpct_setDrawCharM1_asm   ;; Set draw char colours
                            198 
                            199    ;; Calculate a video-memory location for printing a string
   680E 11 00 C0      [10]  200    ld   de, #CPCT_VMEM_START_ASM ;; DE = Pointer to start of the screen
   6811 06 BE         [ 7]  201    ld    b, #190                  ;; B = y coordinate (24 = 0x18)
   6813 0E 47         [ 7]  202    ld    c, #71                 ;; C = x coordinate (16 = 0x10)
                            203 
   6815 CD 6C B0      [17]  204    call cpct_getScreenPtr_asm    ;; Calculate video memory location and return it in HL
                            205 
                            206    ;; Print the string in video memory
                            207    ;; HL already points to video memory, as it is the return
                            208    ;; value from cpct_getScreenPtr_asm
   6818 FD 21 3B 67   [14]  209    ld   iy, #Escribir8    ;; IY = Pointer to the string 
                            210    
   681C CD 63 AE      [17]  211    call cpct_drawStringM1_asm
   681F C9            [10]  212    ret
   6820                     213    pintarNueveUnidades2::
   6820 16 02         [ 7]  214     ld    d, #2         ;; D = Background PEN (0)
   6822 1E 03         [ 7]  215    ld    e, #3         ;; E = Foreground PEN (3) ;;3 rojo, 2 azul, 1 amarillo, 0 fondo, mas de 3 multicolor
                            216 
   6824 CD 88 B0      [17]  217    call cpct_setDrawCharM1_asm   ;; Set draw char colours
                            218 
                            219    ;; Calculate a video-memory location for printing a string
   6827 11 00 C0      [10]  220    ld   de, #CPCT_VMEM_START_ASM ;; DE = Pointer to start of the screen
   682A 06 BE         [ 7]  221    ld    b, #190                  ;; B = y coordinate (24 = 0x18)
   682C 0E 47         [ 7]  222    ld    c, #71                 ;; C = x coordinate (16 = 0x10)
                            223 
   682E CD 6C B0      [17]  224    call cpct_getScreenPtr_asm    ;; Calculate video memory location and return it in HL
                            225 
                            226    ;; Print the string in video memory
                            227    ;; HL already points to video memory, as it is the return
                            228    ;; value from cpct_getScreenPtr_asm
   6831 FD 21 3D 67   [14]  229    ld   iy, #Escribir9    ;; IY = Pointer to the string 
                            230    
   6835 CD 63 AE      [17]  231    call cpct_drawStringM1_asm
   6838 C9            [10]  232    ret
