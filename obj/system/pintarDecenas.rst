...
Hexadecimal [16-Bits]
   ...
   7C92 30 00                19 Escribir0: .asciz "0"
   7C94 31 00                20 Escribir1: .asciz "1"
   7C96 32 00                21 Escribir2: .asciz "2"
   7C98 33 00                22 Escribir3: .asciz "3"
   7C9A 34 00                23 Escribir4: .asciz "4"
   7C9C 35 00                24 Escribir5: .asciz "5"
   7C9E 36 00                25 Escribir6: .asciz "6"
   7CA0 37 00                26 Escribir7: .asciz "7"
   7CA2 38 00                27 Escribir8: .asciz "8"
   7CA4 39 00                28 Escribir9: .asciz "9"
                             29 
                             30 
   7CA6                      31    pintarCeroDecenas::
   7CA6 16 02         [ 7]   32     ld    d, #2         ;; D = Background PEN (0)
   7CA8 1E 03         [ 7]   33    ld    e, #3         ;; E = Foreground PEN (3) ;;3 rojo, 2 azul, 1 amarillo, 0 fondo, mas de 3 multicolor
                             34 
   7CAA CD 88 B0      [17]   35    call cpct_setDrawCharM1_asm   ;; Set draw char colours
                             36 
                             37    ;; Calculate a video-memory location for printing a string
   7CAD 11 00 C0      [10]   38    ld   de, #CPCT_VMEM_START_ASM ;; DE = Pointer to start of the screen
   7CB0 06 22         [ 7]   39    ld    b, #34                  ;; B = y coordinate (24 = 0x18)
   7CB2 0E 19         [ 7]   40    ld    c, #25                 ;; C = x coordinate (16 = 0x10)
                             41 
   7CB4 CD 6C B0      [17]   42    call cpct_getScreenPtr_asm    ;; Calculate video memory location and return it in HL
                             43 
   ...
   7CB7 FD 21 92 7C   [14]   47    ld   iy, #Escribir0    ;; IY = Pointer to the string 
                             48    
   7CBB CD 63 AE      [17]   49    call cpct_drawStringM1_asm
   7CBE C9            [10]   50    ret
                             51 
   7CBF                      52    pintarUnoDecenas::
   7CBF 16 02         [ 7]   53     ld    d, #2         ;; D = Background PEN (0)
   7CC1 1E 03         [ 7]   54    ld    e, #3         ;; E = Foreground PEN (3) ;;3 rojo, 2 azul, 1 amarillo, 0 fondo, mas de 3 multicolor
                             55 
   7CC3 CD 88 B0      [17]   56    call cpct_setDrawCharM1_asm   ;; Set draw char colours
                             57 
                             58    ;; Calculate a video-memory location for printing a string
   7CC6 11 00 C0      [10]   59    ld   de, #CPCT_VMEM_START_ASM ;; DE = Pointer to start of the screen
   7CC9 06 22         [ 7]   60    ld    b, #34                  ;; B = y coordinate (24 = 0x18)
   7CCB 0E 19         [ 7]   61    ld    c, #25                 ;; C = x coordinate (16 = 0x10)
                             62 
   7CCD CD 6C B0      [17]   63    call cpct_getScreenPtr_asm    ;; Calculate video memory location and return it in HL
                             64 
   ...
   7CD0 FD 21 94 7C   [14]   68    ld   iy, #Escribir1    ;; IY = Pointer to the string 
                             69    
   7CD4 CD 63 AE      [17]   70    call cpct_drawStringM1_asm
   7CD7 C9            [10]   71    ret
                             72 
   7CD8                      73    pintarDosDecenas::
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (Zilog Z80 / Hitachi HD64180), page 57.
Hexadecimal [16-Bits]



   7CD8 16 02         [ 7]   74     ld    d, #2         ;; D = Background PEN (0)
   7CDA 1E 03         [ 7]   75    ld    e, #3         ;; E = Foreground PEN (3) ;;3 rojo, 2 azul, 1 amarillo, 0 fondo, mas de 3 multicolor
                             76 
   7CDC CD 88 B0      [17]   77    call cpct_setDrawCharM1_asm   ;; Set draw char colours
                             78 
                             79    ;; Calculate a video-memory location for printing a string
   7CDF 11 00 C0      [10]   80    ld   de, #CPCT_VMEM_START_ASM ;; DE = Pointer to start of the screen
   7CE2 06 22         [ 7]   81    ld    b, #34                  ;; B = y coordinate (24 = 0x18)
   7CE4 0E 19         [ 7]   82    ld    c, #25                 ;; C = x coordinate (16 = 0x10)
                             83 
   7CE6 CD 6C B0      [17]   84    call cpct_getScreenPtr_asm    ;; Calculate video memory location and return it in HL
                             85 
   ...
   7CE9 FD 21 96 7C   [14]   89    ld   iy, #Escribir2    ;; IY = Pointer to the string 
                             90    
   7CED CD 63 AE      [17]   91    call cpct_drawStringM1_asm
   7CF0 C9            [10]   92    ret
   7CF1                      93    pintarTresDecenas::
   7CF1 16 02         [ 7]   94     ld    d, #2         ;; D = Background PEN (0)
   7CF3 1E 03         [ 7]   95    ld    e, #3         ;; E = Foreground PEN (3) ;;3 rojo, 2 azul, 1 amarillo, 0 fondo, mas de 3 multicolor
                             96 
   7CF5 CD 88 B0      [17]   97    call cpct_setDrawCharM1_asm   ;; Set draw char colours
                             98 
                             99    ;; Calculate a video-memory location for printing a string
   7CF8 11 00 C0      [10]  100    ld   de, #CPCT_VMEM_START_ASM ;; DE = Pointer to start of the screen
   7CFB 06 22         [ 7]  101    ld    b, #34                  ;; B = y coordinate (24 = 0x18)
   7CFD 0E 19         [ 7]  102    ld    c, #25                 ;; C = x coordinate (16 = 0x10)
                            103 
   7CFF CD 6C B0      [17]  104    call cpct_getScreenPtr_asm    ;; Calculate video memory location and return it in HL
                            105 
   ...
   7D02 FD 21 98 7C   [14]  109    ld   iy, #Escribir3    ;; IY = Pointer to the string 
                            110    
   7D06 CD 63 AE      [17]  111    call cpct_drawStringM1_asm
   7D09 C9            [10]  112    ret
   7D0A                     113    pintarCuatroDecenas::
   7D0A 16 02         [ 7]  114     ld    d, #2         ;; D = Background PEN (0)
   7D0C 1E 03         [ 7]  115    ld    e, #3         ;; E = Foreground PEN (3) ;;3 rojo, 2 azul, 1 amarillo, 0 fondo, mas de 3 multicolor
                            116 
   7D0E CD 88 B0      [17]  117    call cpct_setDrawCharM1_asm   ;; Set draw char colours
                            118 
                            119    ;; Calculate a video-memory location for printing a string
   7D11 11 00 C0      [10]  120    ld   de, #CPCT_VMEM_START_ASM ;; DE = Pointer to start of the screen
   7D14 06 22         [ 7]  121    ld    b, #34                  ;; B = y coordinate (24 = 0x18)
   7D16 0E 19         [ 7]  122    ld    c, #25                 ;; C = x coordinate (16 = 0x10)
                            123 
   7D18 CD 6C B0      [17]  124    call cpct_getScreenPtr_asm    ;; Calculate video memory location and return it in HL
                            125 
...
Hexadecimal [16-Bits]
   ...
   7D1B FD 21 9A 7C   [14]  129    ld   iy, #Escribir4    ;; IY = Pointer to the string 
                            130    
   7D1F CD 63 AE      [17]  131    call cpct_drawStringM1_asm
   7D22 C9            [10]  132    ret
   7D23                     133    pintarCincoDecenas::
   7D23 16 02         [ 7]  134     ld    d, #2         ;; D = Background PEN (0)
   7D25 1E 03         [ 7]  135    ld    e, #3         ;; E = Foreground PEN (3) ;;3 rojo, 2 azul, 1 amarillo, 0 fondo, mas de 3 multicolor
                            136 
   7D27 CD 88 B0      [17]  137    call cpct_setDrawCharM1_asm   ;; Set draw char colours
                            138 
                            139    ;; Calculate a video-memory location for printing a string
   7D2A 11 00 C0      [10]  140    ld   de, #CPCT_VMEM_START_ASM ;; DE = Pointer to start of the screen
   7D2D 06 22         [ 7]  141    ld    b, #34                  ;; B = y coordinate (24 = 0x18)
   7D2F 0E 19         [ 7]  142    ld    c, #25                 ;; C = x coordinate (16 = 0x10)
                            143 
   7D31 CD 6C B0      [17]  144    call cpct_getScreenPtr_asm    ;; Calculate video memory location and return it in HL
                            145 
   ...
   7D34 FD 21 9C 7C   [14]  149    ld   iy, #Escribir5    ;; IY = Pointer to the string 
                            150    
   7D38 CD 63 AE      [17]  151    call cpct_drawStringM1_asm
   7D3B C9            [10]  152    ret
   7D3C                     153    pintarSeisDecenas::
   7D3C 16 02         [ 7]  154     ld    d, #2         ;; D = Background PEN (0)
   7D3E 1E 03         [ 7]  155    ld    e, #3         ;; E = Foreground PEN (3) ;;3 rojo, 2 azul, 1 amarillo, 0 fondo, mas de 3 multicolor
                            156 
   7D40 CD 88 B0      [17]  157    call cpct_setDrawCharM1_asm   ;; Set draw char colours
                            158 
                            159    ;; Calculate a video-memory location for printing a string
   7D43 11 00 C0      [10]  160    ld   de, #CPCT_VMEM_START_ASM ;; DE = Pointer to start of the screen
   7D46 06 22         [ 7]  161    ld    b, #34                  ;; B = y coordinate (24 = 0x18)
   7D48 0E 19         [ 7]  162    ld    c, #25                 ;; C = x coordinate (16 = 0x10)
                            163 
   7D4A CD 6C B0      [17]  164    call cpct_getScreenPtr_asm    ;; Calculate video memory location and return it in HL
                            165 
   ...
   7D4D FD 21 9E 7C   [14]  169    ld   iy, #Escribir6    ;; IY = Pointer to the string 
                            170    
   7D51 CD 63 AE      [17]  171    call cpct_drawStringM1_asm
   7D54 C9            [10]  172    ret
   7D55                     173    pintarSieteDecenas::
   7D55 16 02         [ 7]  174     ld    d, #2         ;; D = Background PEN (0)
   7D57 1E 03         [ 7]  175    ld    e, #3         ;; E = Foreground PEN (3) ;;3 rojo, 2 azul, 1 amarillo, 0 fondo, mas de 3 multicolor
                            176 
   7D59 CD 88 B0      [17]  177    call cpct_setDrawCharM1_asm   ;; Set draw char colours
                            178 
                            179    ;; Calculate a video-memory location for printing a string
   7D5C 11 00 C0      [10]  180    ld   de, #CPCT_VMEM_START_ASM ;; DE = Pointer to start of the screen
   7D5F 06 22         [ 7]  181    ld    b, #34                  ;; B = y coordinate (24 = 0x18)
   7D61 0E 19         [ 7]  182    ld    c, #25                 ;; C = x coordinate (16 = 0x10)
                            183 
...
Hexadecimal [16-Bits]
   ...
   7D63 CD 6C B0      [17]  184    call cpct_getScreenPtr_asm    ;; Calculate video memory location and return it in HL
                            185 
   ...
   7D66 FD 21 A0 7C   [14]  189    ld   iy, #Escribir7    ;; IY = Pointer to the string 
                            190    
   7D6A CD 63 AE      [17]  191    call cpct_drawStringM1_asm
   7D6D C9            [10]  192    ret
   7D6E                     193    pintarOchoDecenas::
   7D6E 16 02         [ 7]  194     ld    d, #2         ;; D = Background PEN (0)
   7D70 1E 03         [ 7]  195    ld    e, #3         ;; E = Foreground PEN (3) ;;3 rojo, 2 azul, 1 amarillo, 0 fondo, mas de 3 multicolor
                            196 
   7D72 CD 88 B0      [17]  197    call cpct_setDrawCharM1_asm   ;; Set draw char colours
                            198 
                            199    ;; Calculate a video-memory location for printing a string
   7D75 11 00 C0      [10]  200    ld   de, #CPCT_VMEM_START_ASM ;; DE = Pointer to start of the screen
   7D78 06 22         [ 7]  201    ld    b, #34                  ;; B = y coordinate (24 = 0x18)
   7D7A 0E 19         [ 7]  202    ld    c, #25                 ;; C = x coordinate (16 = 0x10)
                            203 
   7D7C CD 6C B0      [17]  204    call cpct_getScreenPtr_asm    ;; Calculate video memory location and return it in HL
                            205 
   ...
   7D7F FD 21 A2 7C   [14]  209    ld   iy, #Escribir8    ;; IY = Pointer to the string 
                            210    
   7D83 CD 63 AE      [17]  211    call cpct_drawStringM1_asm
   7D86 C9            [10]  212    ret
   7D87                     213    pintarNueveDecenas::
   7D87 16 02         [ 7]  214     ld    d, #2         ;; D = Background PEN (0)
   7D89 1E 03         [ 7]  215    ld    e, #3         ;; E = Foreground PEN (3) ;;3 rojo, 2 azul, 1 amarillo, 0 fondo, mas de 3 multicolor
                            216 
   7D8B CD 88 B0      [17]  217    call cpct_setDrawCharM1_asm   ;; Set draw char colours
                            218 
                            219    ;; Calculate a video-memory location for printing a string
   7D8E 11 00 C0      [10]  220    ld   de, #CPCT_VMEM_START_ASM ;; DE = Pointer to start of the screen
   7D91 06 22         [ 7]  221    ld    b, #34                  ;; B = y coordinate (24 = 0x18)
   7D93 0E 19         [ 7]  222    ld    c, #25                 ;; C = x coordinate (16 = 0x10)
                            223 
   7D95 CD 6C B0      [17]  224    call cpct_getScreenPtr_asm    ;; Calculate video memory location and return it in HL
                            225 
   ...
   7D98 FD 21 A4 7C   [14]  229    ld   iy, #Escribir9    ;; IY = Pointer to the string 
                            230    
   7D9C CD 63 AE      [17]  231    call cpct_drawStringM1_asm
   7D9F C9            [10]  232    ret
