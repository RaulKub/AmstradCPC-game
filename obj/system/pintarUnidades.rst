...
Hexadecimal [16-Bits]
   ...
   48CB 30 00                19 Escribir0: .asciz "0"
   48CD 31 00                20 Escribir1: .asciz "1"
   48CF 32 00                21 Escribir2: .asciz "2"
   48D1 33 00                22 Escribir3: .asciz "3"
   48D3 34 00                23 Escribir4: .asciz "4"
   48D5 35 00                24 Escribir5: .asciz "5"
   48D7 36 00                25 Escribir6: .asciz "6"
   48D9 37 00                26 Escribir7: .asciz "7"
   48DB 38 00                27 Escribir8: .asciz "8"
   48DD 39 00                28 Escribir9: .asciz "9"
                             29 
                             30 
   48DF                      31    pintarCeroUnidades::
   48DF 16 02         [ 7]   32     ld    d, #2         ;; D = Background PEN (0)
   48E1 1E 03         [ 7]   33    ld    e, #3         ;; E = Foreground PEN (3) ;;3 rojo, 2 azul, 1 amarillo, 0 fondo, mas de 3 multicolor
                             34 
   48E3 CD 88 B0      [17]   35    call cpct_setDrawCharM1_asm   ;; Set draw char colours
                             36 
                             37    ;; Calculate a video-memory location for printing a string
   48E6 11 00 C0      [10]   38    ld   de, #CPCT_VMEM_START_ASM ;; DE = Pointer to start of the screen
   48E9 06 22         [ 7]   39    ld    b, #34                  ;; B = y coordinate (24 = 0x18)
   48EB 0E 1B         [ 7]   40    ld    c, #27                 ;; C = x coordinate (16 = 0x10)
                             41 
   48ED CD 6C B0      [17]   42    call cpct_getScreenPtr_asm    ;; Calculate video memory location and return it in HL
                             43 
   ...
   48F0 FD 21 CB 48   [14]   47    ld   iy, #Escribir0    ;; IY = Pointer to the string 
                             48    
   48F4 CD 63 AE      [17]   49    call cpct_drawStringM1_asm
   48F7 C9            [10]   50    ret
                             51 
   48F8                      52    pintarUnoUnidades::
   48F8 16 02         [ 7]   53     ld    d, #2         ;; D = Background PEN (0)
   48FA 1E 03         [ 7]   54    ld    e, #3         ;; E = Foreground PEN (3) ;;3 rojo, 2 azul, 1 amarillo, 0 fondo, mas de 3 multicolor
                             55 
   48FC CD 88 B0      [17]   56    call cpct_setDrawCharM1_asm   ;; Set draw char colours
                             57 
                             58    ;; Calculate a video-memory location for printing a string
   48FF 11 00 C0      [10]   59    ld   de, #CPCT_VMEM_START_ASM ;; DE = Pointer to start of the screen
   4902 06 22         [ 7]   60    ld    b, #34                  ;; B = y coordinate (24 = 0x18)
   4904 0E 1B         [ 7]   61    ld    c, #27                 ;; C = x coordinate (16 = 0x10)
                             62 
   4906 CD 6C B0      [17]   63    call cpct_getScreenPtr_asm    ;; Calculate video memory location and return it in HL
                             64 
   ...
   4909 FD 21 CD 48   [14]   68    ld   iy, #Escribir1    ;; IY = Pointer to the string 
                             69    
   490D CD 63 AE      [17]   70    call cpct_drawStringM1_asm
   4910 C9            [10]   71    ret
                             72 
   4911                      73    pintarDosUnidades::
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (Zilog Z80 / Hitachi HD64180), page 57.
Hexadecimal [16-Bits]



   4911 16 02         [ 7]   74     ld    d, #2         ;; D = Background PEN (0)
   4913 1E 03         [ 7]   75    ld    e, #3         ;; E = Foreground PEN (3) ;;3 rojo, 2 azul, 1 amarillo, 0 fondo, mas de 3 multicolor
                             76 
   4915 CD 88 B0      [17]   77    call cpct_setDrawCharM1_asm   ;; Set draw char colours
                             78 
                             79    ;; Calculate a video-memory location for printing a string
   4918 11 00 C0      [10]   80    ld   de, #CPCT_VMEM_START_ASM ;; DE = Pointer to start of the screen
   491B 06 22         [ 7]   81    ld    b, #34                  ;; B = y coordinate (24 = 0x18)
   491D 0E 1B         [ 7]   82    ld    c, #27                 ;; C = x coordinate (16 = 0x10)
                             83 
   491F CD 6C B0      [17]   84    call cpct_getScreenPtr_asm    ;; Calculate video memory location and return it in HL
                             85 
   ...
   4922 FD 21 CF 48   [14]   89    ld   iy, #Escribir2    ;; IY = Pointer to the string 
                             90    
   4926 CD 63 AE      [17]   91    call cpct_drawStringM1_asm
   4929 C9            [10]   92    ret
   492A                      93    pintarTresUnidades::
   492A 16 02         [ 7]   94     ld    d, #2         ;; D = Background PEN (0)
   492C 1E 03         [ 7]   95    ld    e, #3         ;; E = Foreground PEN (3) ;;3 rojo, 2 azul, 1 amarillo, 0 fondo, mas de 3 multicolor
                             96 
   492E CD 88 B0      [17]   97    call cpct_setDrawCharM1_asm   ;; Set draw char colours
                             98 
                             99    ;; Calculate a video-memory location for printing a string
   4931 11 00 C0      [10]  100    ld   de, #CPCT_VMEM_START_ASM ;; DE = Pointer to start of the screen
   4934 06 22         [ 7]  101    ld    b, #34                  ;; B = y coordinate (24 = 0x18)
   4936 0E 1B         [ 7]  102    ld    c, #27                 ;; C = x coordinate (16 = 0x10)
                            103 
   4938 CD 6C B0      [17]  104    call cpct_getScreenPtr_asm    ;; Calculate video memory location and return it in HL
                            105 
   ...
   493B FD 21 D1 48   [14]  109    ld   iy, #Escribir3    ;; IY = Pointer to the string 
                            110    
   493F CD 63 AE      [17]  111    call cpct_drawStringM1_asm
   4942 C9            [10]  112    ret
   4943                     113    pintarCuatroUnidades::
   4943 16 02         [ 7]  114     ld    d, #2         ;; D = Background PEN (0)
   4945 1E 03         [ 7]  115    ld    e, #3         ;; E = Foreground PEN (3) ;;3 rojo, 2 azul, 1 amarillo, 0 fondo, mas de 3 multicolor
                            116 
   4947 CD 88 B0      [17]  117    call cpct_setDrawCharM1_asm   ;; Set draw char colours
                            118 
                            119    ;; Calculate a video-memory location for printing a string
   494A 11 00 C0      [10]  120    ld   de, #CPCT_VMEM_START_ASM ;; DE = Pointer to start of the screen
   494D 06 22         [ 7]  121    ld    b, #34                  ;; B = y coordinate (24 = 0x18)
   494F 0E 1B         [ 7]  122    ld    c, #27                 ;; C = x coordinate (16 = 0x10)
                            123 
   4951 CD 6C B0      [17]  124    call cpct_getScreenPtr_asm    ;; Calculate video memory location and return it in HL
                            125 
...
Hexadecimal [16-Bits]
   ...
   4954 FD 21 D3 48   [14]  129    ld   iy, #Escribir4    ;; IY = Pointer to the string 
                            130    
   4958 CD 63 AE      [17]  131    call cpct_drawStringM1_asm
   495B C9            [10]  132    ret
   495C                     133    pintarCincoUnidades::
   495C 16 02         [ 7]  134     ld    d, #2         ;; D = Background PEN (0)
   495E 1E 03         [ 7]  135    ld    e, #3         ;; E = Foreground PEN (3) ;;3 rojo, 2 azul, 1 amarillo, 0 fondo, mas de 3 multicolor
                            136 
   4960 CD 88 B0      [17]  137    call cpct_setDrawCharM1_asm   ;; Set draw char colours
                            138 
                            139    ;; Calculate a video-memory location for printing a string
   4963 11 00 C0      [10]  140    ld   de, #CPCT_VMEM_START_ASM ;; DE = Pointer to start of the screen
   4966 06 22         [ 7]  141    ld    b, #34                  ;; B = y coordinate (24 = 0x18)
   4968 0E 1B         [ 7]  142    ld    c, #27                 ;; C = x coordinate (16 = 0x10)
                            143 
   496A CD 6C B0      [17]  144    call cpct_getScreenPtr_asm    ;; Calculate video memory location and return it in HL
                            145 
   ...
   496D FD 21 D5 48   [14]  149    ld   iy, #Escribir5    ;; IY = Pointer to the string 
                            150    
   4971 CD 63 AE      [17]  151    call cpct_drawStringM1_asm
   4974 C9            [10]  152    ret
   4975                     153    pintarSeisUnidades::
   4975 16 02         [ 7]  154     ld    d, #2         ;; D = Background PEN (0)
   4977 1E 03         [ 7]  155    ld    e, #3         ;; E = Foreground PEN (3) ;;3 rojo, 2 azul, 1 amarillo, 0 fondo, mas de 3 multicolor
                            156 
   4979 CD 88 B0      [17]  157    call cpct_setDrawCharM1_asm   ;; Set draw char colours
                            158 
                            159    ;; Calculate a video-memory location for printing a string
   497C 11 00 C0      [10]  160    ld   de, #CPCT_VMEM_START_ASM ;; DE = Pointer to start of the screen
   497F 06 22         [ 7]  161    ld    b, #34                  ;; B = y coordinate (24 = 0x18)
   4981 0E 1B         [ 7]  162    ld    c, #27                 ;; C = x coordinate (16 = 0x10)
                            163 
   4983 CD 6C B0      [17]  164    call cpct_getScreenPtr_asm    ;; Calculate video memory location and return it in HL
                            165 
   ...
   4986 FD 21 D7 48   [14]  169    ld   iy, #Escribir6    ;; IY = Pointer to the string 
                            170    
   498A CD 63 AE      [17]  171    call cpct_drawStringM1_asm
   498D C9            [10]  172    ret
   498E                     173    pintarSieteUnidades::
   498E 16 02         [ 7]  174     ld    d, #2         ;; D = Background PEN (0)
   4990 1E 03         [ 7]  175    ld    e, #3         ;; E = Foreground PEN (3) ;;3 rojo, 2 azul, 1 amarillo, 0 fondo, mas de 3 multicolor
                            176 
   4992 CD 88 B0      [17]  177    call cpct_setDrawCharM1_asm   ;; Set draw char colours
                            178 
                            179    ;; Calculate a video-memory location for printing a string
   4995 11 00 C0      [10]  180    ld   de, #CPCT_VMEM_START_ASM ;; DE = Pointer to start of the screen
   4998 06 22         [ 7]  181    ld    b, #34                  ;; B = y coordinate (24 = 0x18)
   499A 0E 1B         [ 7]  182    ld    c, #27                 ;; C = x coordinate (16 = 0x10)
                            183 
...
Hexadecimal [16-Bits]
   ...
   499C CD 6C B0      [17]  184    call cpct_getScreenPtr_asm    ;; Calculate video memory location and return it in HL
                            185 
   ...
   499F FD 21 D9 48   [14]  189    ld   iy, #Escribir7    ;; IY = Pointer to the string 
                            190    
   49A3 CD 63 AE      [17]  191    call cpct_drawStringM1_asm
   49A6 C9            [10]  192    ret
   49A7                     193    pintarOchoUnidades::
   49A7 16 02         [ 7]  194     ld    d, #2         ;; D = Background PEN (0)
   49A9 1E 03         [ 7]  195    ld    e, #3         ;; E = Foreground PEN (3) ;;3 rojo, 2 azul, 1 amarillo, 0 fondo, mas de 3 multicolor
                            196 
   49AB CD 88 B0      [17]  197    call cpct_setDrawCharM1_asm   ;; Set draw char colours
                            198 
                            199    ;; Calculate a video-memory location for printing a string
   49AE 11 00 C0      [10]  200    ld   de, #CPCT_VMEM_START_ASM ;; DE = Pointer to start of the screen
   49B1 06 22         [ 7]  201    ld    b, #34                  ;; B = y coordinate (24 = 0x18)
   49B3 0E 1B         [ 7]  202    ld    c, #27                 ;; C = x coordinate (16 = 0x10)
                            203 
   49B5 CD 6C B0      [17]  204    call cpct_getScreenPtr_asm    ;; Calculate video memory location and return it in HL
                            205 
   ...
   49B8 FD 21 DB 48   [14]  209    ld   iy, #Escribir8    ;; IY = Pointer to the string 
                            210    
   49BC CD 63 AE      [17]  211    call cpct_drawStringM1_asm
   49BF C9            [10]  212    ret
   49C0                     213    pintarNueveUnidades::
   49C0 16 02         [ 7]  214     ld    d, #2         ;; D = Background PEN (0)
   49C2 1E 03         [ 7]  215    ld    e, #3         ;; E = Foreground PEN (3) ;;3 rojo, 2 azul, 1 amarillo, 0 fondo, mas de 3 multicolor
                            216 
   49C4 CD 88 B0      [17]  217    call cpct_setDrawCharM1_asm   ;; Set draw char colours
                            218 
                            219    ;; Calculate a video-memory location for printing a string
   49C7 11 00 C0      [10]  220    ld   de, #CPCT_VMEM_START_ASM ;; DE = Pointer to start of the screen
   49CA 06 22         [ 7]  221    ld    b, #34                  ;; B = y coordinate (24 = 0x18)
   49CC 0E 1B         [ 7]  222    ld    c, #27                 ;; C = x coordinate (16 = 0x10)
                            223 
   49CE CD 6C B0      [17]  224    call cpct_getScreenPtr_asm    ;; Calculate video memory location and return it in HL
                            225 
   ...
   49D1 FD 21 DD 48   [14]  229    ld   iy, #Escribir9    ;; IY = Pointer to the string 
                            230    
   49D5 CD 63 AE      [17]  231    call cpct_drawStringM1_asm
   49D8 C9            [10]  232    ret
