...
Hexadecimal [16-Bits]
   ...
   9D3A                      21 fondo::
                             22 
   9D3A 3E 49         [ 7]   23 ld      a, #0x49
   9D3C                      24 buclesuelo:
   9D3C F5            [11]   25     push af
   9D3D 11 00 C0      [10]   26     ld      de, #0xC000        ;;Puntero a la posición en pantalla (COOO sería el inicio de la pantalla)
   9D40 4F            [ 4]   27     ld      c,  a              ;;Coordenada X 
   9D41 06 90         [ 7]   28     ld      b,  #0x90         ;;Coordenada Y 
   9D43 CD 6C B0      [17]   29     call cpct_getScreenPtr_asm  ;;Función que calcula la dirección de memoria de video con esos parámetros
                             30 
   9D46 EB            [ 4]   31     ex      de, hl             ;;Intercambia los 2 valores (supongo que la fucion de dibujo lo usará)
   9D47 3E 0F         [ 7]   32     ld      a,  #0x0F          ;;Color (en la posición de la entidad)
   9D49 0E 01         [ 7]   33     ld      c,  #1        ;;Ancho (en la posición de la entidad)
   9D4B 06 01         [ 7]   34     ld      b,  #1         ;;Alto (en la posición de la entidad)
   9D4D CD C1 AF      [17]   35     call cpct_drawSolidBox_asm  ;;Función de dibujado de cpc
                             36     
   9D50 F1            [10]   37     pop af
   9D51 3D            [ 4]   38     dec a
   9D52 20 E8         [12]   39     jr nz, buclesuelo
                             40 
                             41 
                             42 
                             43 ;;AQUI ESTAMOS PINTANDO EL CUADRADO ROJO DE ARRIBA---------------------
   9D54 3E 02         [ 7]   44     ld a, #0x02
   9D56 11 00 C0      [10]   45     ld      de, #0xC000        ;;Puntero a la posición en pantalla (COOO sería el inicio de la pantalla)
   9D59 4F            [ 4]   46     ld      c,  a              ;;Coordenada X 
   9D5A 06 01         [ 7]   47     ld      b,  #0x01         ;;Coordenada Y 
   9D5C CD 6C B0      [17]   48     call cpct_getScreenPtr_asm  ;;Función que calcula la dirección de memoria de video con esos parámetros
                             49 
   9D5F EB            [ 4]   50     ex      de, hl             ;;Intercambia los 2 valores (supongo que la fucion de dibujo lo usará)
   9D60 3E FF         [ 7]   51     ld      a,  #0xFF          ;;Color (en la posición de la entidad)
   9D62 0E 40         [ 7]   52     ld      c,  #64        ;;Ancho (en la posición de la entidad)
   9D64 06 16         [ 7]   53     ld      b,  #22         ;;Alto (en la posición de la entidad)
   9D66 CD C1 AF      [17]   54     call cpct_drawSolidBox_asm  ;;Función de dibujado de cpc
                             55 
                             56 ;;AQUI EL SEGUNDO CUADRADO PARA QUE LLEGUE HASTA EL FINAL -------------
   9D69 3E 40         [ 7]   57     ld a, #0x040
   9D6B 11 00 C0      [10]   58     ld      de, #0xC000        ;;Puntero a la posición en pantalla (COOO sería el inicio de la pantalla)
   9D6E 4F            [ 4]   59     ld      c,  a              ;;Coordenada X 
   9D6F 06 01         [ 7]   60     ld      b,  #0x01         ;;Coordenada Y 
   9D71 CD 6C B0      [17]   61     call cpct_getScreenPtr_asm  ;;Función que calcula la dirección de memoria de video con esos parámetros
                             62 
   9D74 EB            [ 4]   63     ex      de, hl             ;;Intercambia los 2 valores (supongo que la fucion de dibujo lo usará)
   9D75 3E FF         [ 7]   64     ld      a,  #0xFF          ;;Color (en la posición de la entidad)
   9D77 0E 0E         [ 7]   65     ld      c,  #14        ;;Ancho (en la posición de la entidad)
   9D79 06 16         [ 7]   66     ld      b,  #22         ;;Alto (en la posición de la entidad)
   9D7B CD C1 AF      [17]   67     call cpct_drawSolidBox_asm  ;;Función de dibujado de cpc
                             68 
                             69 
                             70 ;;AQUI LOS CUADRADOS AZULES A MODO DE LADRILLOS--------------------
   9D7E 3E F7         [ 7]   71     ld a, #0xF7 ;;0xDF
   9D80                      72 techo:
...
Hexadecimal [16-Bits]
   ...
   9D80 F5            [11]   73     push af
   9D81 11 00 C0      [10]   74     ld      de, #0xC000        ;;Puntero a la posición en pantalla (COOO sería el inicio de la pantalla)
   9D84 4F            [ 4]   75     ld      c,  a              ;;Coordenada X 
   9D85 06 02         [ 7]   76     ld      b,  #0x02         ;;Coordenada Y 
   9D87 CD 6C B0      [17]   77     call cpct_getScreenPtr_asm  ;;Función que calcula la dirección de memoria de video con esos parámetros
                             78 
   9D8A EB            [ 4]   79     ex      de, hl             ;;Intercambia los 2 valores (supongo que la fucion de dibujo lo usará)
   9D8B 3E 00         [ 7]   80     ld      a,  #0x00          ;;Color (en la posición de la entidad)
   9D8D 0E 02         [ 7]   81     ld      c,  #2        ;;Ancho (en la posición de la entidad)
   9D8F 06 04         [ 7]   82     ld      b,  #4         ;;Alto (en la posición de la entidad)
   9D91 CD C1 AF      [17]   83     call cpct_drawSolidBox_asm  ;;Función de dibujado de cpc
                             84 
   9D94 F1            [10]   85     pop af
   9D95 3D            [ 4]   86     dec a
   9D96 28 09         [12]   87     jr z, fin
   9D98 3D            [ 4]   88     dec a
   9D99 28 06         [12]   89     jr z, fin
   9D9B 3D            [ 4]   90     dec a
   9D9C 28 03         [12]   91     jr z, fin
   9D9E 3D            [ 4]   92     dec a
   9D9F 20 DF         [12]   93     jr nz, techo
   9DA1                      94 fin:
                             95 
                             96 ;;DIBUJANDO LAS TUBERIAS----------------
                             97 
                             98 ;;IZQUIERDA
   9DA1 3E 03         [ 7]   99 ld a, #0x03
   9DA3 11 00 C0      [10]  100     ld      de, #0xC000        ;;Puntero a la posición en pantalla (COOO sería el inicio de la pantalla)
   9DA6 4F            [ 4]  101     ld      c,  a              ;;Coordenada X 
   9DA7 06 50         [ 7]  102     ld      b,  #0x50         ;;Coordenada Y 
   9DA9 CD 6C B0      [17]  103     call cpct_getScreenPtr_asm  ;;Función que calcula la dirección de memoria de video con esos parámetros
                            104 
   9DAC EB            [ 4]  105     ex      de, hl             ;;Intercambia los 2 valores (supongo que la fucion de dibujo lo usará)
   9DAD 3E 0F         [ 7]  106     ld      a,  #0x0F          ;;Color (en la posición de la entidad)
   9DAF 0E 02         [ 7]  107     ld      c,  #2        ;;Ancho (en la posición de la entidad)
   9DB1 06 40         [ 7]  108     ld      b,  #64         ;;Alto (en la posición de la entidad)
   9DB3 CD C1 AF      [17]  109     call cpct_drawSolidBox_asm  ;;Función de dibujado de cpc
                            110 
   9DB6 3E 00         [ 7]  111     ld a, #0x00
   9DB8 11 00 C0      [10]  112     ld      de, #0xC000        ;;Puntero a la posición en pantalla (COOO sería el inicio de la pantalla)
   9DBB 4F            [ 4]  113     ld      c,  a              ;;Coordenada X 
   9DBC 06 50         [ 7]  114     ld      b,  #0x50         ;;Coordenada Y 
   9DBE CD 6C B0      [17]  115     call cpct_getScreenPtr_asm  ;;Función que calcula la dirección de memoria de video con esos parámetros
                            116 
   9DC1 EB            [ 4]  117     ex      de, hl             ;;Intercambia los 2 valores (supongo que la fucion de dibujo lo usará)
   9DC2 3E 0F         [ 7]  118     ld      a,  #0x0F          ;;Color (en la posición de la entidad)
   9DC4 0E 03         [ 7]  119     ld      c,  #3        ;;Ancho (en la posición de la entidad)
   9DC6 06 06         [ 7]  120     ld      b,  #6         ;;Alto (en la posición de la entidad)
   9DC8 CD C1 AF      [17]  121     call cpct_drawSolidBox_asm  ;;Función de dibujado de cpc
                            122 
                            123 
                            124 ;;AQUI ESTAMOS DIBUJANDO EL TROZO DE TUBERIA POR EL QUE SALE EL ENEMIGO---------
   9DCB 3E 05         [ 7]  125     ld a, #0x05
   9DCD 11 00 C0      [10]  126     ld      de, #0xC000        ;;Puntero a la posición en pantalla (COOO sería el inicio de la pantalla)
   9DD0 4F            [ 4]  127     ld      c,  a              ;;Coordenada X 
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (Zilog Z80 / Hitachi HD64180), page 57.
Hexadecimal [16-Bits]



   9DD1 06 85         [ 7]  128     ld      b,  #0x85         ;;Coordenada Y 
   9DD3 CD 6C B0      [17]  129     call cpct_getScreenPtr_asm  ;;Función que calcula la dirección de memoria de video con esos parámetros
                            130 
   9DD6 EB            [ 4]  131     ex      de, hl             ;;Intercambia los 2 valores (supongo que la fucion de dibujo lo usará)
   9DD7 3E EE         [ 7]  132     ld      a,  #0xEE          ;;Color (en la posición de la entidad)
   9DD9 0E 01         [ 7]  133     ld      c,  #1        ;;Ancho (en la posición de la entidad)
   9DDB 06 01         [ 7]  134     ld      b,  #1         ;;Alto (en la posición de la entidad)
   9DDD CD C1 AF      [17]  135     call cpct_drawSolidBox_asm  ;;Función de dibujado de cpc
                            136 
   9DE0 3E 05         [ 7]  137     ld a, #0x05
   9DE2 11 00 C0      [10]  138     ld      de, #0xC000        ;;Puntero a la posición en pantalla (COOO sería el inicio de la pantalla)
   9DE5 4F            [ 4]  139     ld      c,  a              ;;Coordenada X 
   9DE6 06 86         [ 7]  140     ld      b,  #0x86         ;;Coordenada Y 
   9DE8 CD 6C B0      [17]  141     call cpct_getScreenPtr_asm  ;;Función que calcula la dirección de memoria de video con esos parámetros
                            142 
   9DEB EB            [ 4]  143     ex      de, hl             ;;Intercambia los 2 valores (supongo que la fucion de dibujo lo usará)
   9DEC 3E 3F         [ 7]  144     ld      a,  #0x3F          ;;Color (en la posición de la entidad)
   9DEE 0E 01         [ 7]  145     ld      c,  #1        ;;Ancho (en la posición de la entidad)
   9DF0 06 01         [ 7]  146     ld      b,  #1         ;;Alto (en la posición de la entidad)
   9DF2 CD C1 AF      [17]  147     call cpct_drawSolidBox_asm  ;;Función de dibujado de cpc
                            148 
                            149 
   9DF5 3E 05         [ 7]  150 ld a, #0x05
   9DF7 11 00 C0      [10]  151     ld      de, #0xC000        ;;Puntero a la posición en pantalla (COOO sería el inicio de la pantalla)
   9DFA 4F            [ 4]  152     ld      c,  a              ;;Coordenada X 
   9DFB 06 87         [ 7]  153     ld      b,  #0x87         ;;Coordenada Y 
   9DFD CD 6C B0      [17]  154     call cpct_getScreenPtr_asm  ;;Función que calcula la dirección de memoria de video con esos parámetros
                            155 
   9E00 EB            [ 4]  156     ex      de, hl             ;;Intercambia los 2 valores (supongo que la fucion de dibujo lo usará)
   9E01 3E 1F         [ 7]  157     ld      a,  #0x1F          ;;Color (en la posición de la entidad)
   9E03 0E 01         [ 7]  158     ld      c,  #1        ;;Ancho (en la posición de la entidad)
   9E05 06 01         [ 7]  159     ld      b,  #1         ;;Alto (en la posición de la entidad)
   9E07 CD C1 AF      [17]  160     call cpct_drawSolidBox_asm  ;;Función de dibujado de cpc
                            161 
                            162 
   9E0A 3E 05         [ 7]  163 ld a, #0x05
   9E0C 11 00 C0      [10]  164     ld      de, #0xC000        ;;Puntero a la posición en pantalla (COOO sería el inicio de la pantalla)
   9E0F 4F            [ 4]  165     ld      c,  a              ;;Coordenada X 
   9E10 06 88         [ 7]  166     ld      b,  #0x88         ;;Coordenada Y 
   9E12 CD 6C B0      [17]  167     call cpct_getScreenPtr_asm  ;;Función que calcula la dirección de memoria de video con esos parámetros
                            168 
   9E15 EB            [ 4]  169     ex      de, hl             ;;Intercambia los 2 valores (supongo que la fucion de dibujo lo usará)
   9E16 3E 1F         [ 7]  170     ld      a,  #0x1F          ;;Color (en la posición de la entidad)
   9E18 0E 01         [ 7]  171     ld      c,  #1        ;;Ancho (en la posición de la entidad)
   9E1A 06 01         [ 7]  172     ld      b,  #1         ;;Alto (en la posición de la entidad)
   9E1C CD C1 AF      [17]  173     call cpct_drawSolidBox_asm  ;;Función de dibujado de cpc
                            174 
                            175 
   9E1F 3E 05         [ 7]  176 ld a, #0x05
   9E21 11 00 C0      [10]  177     ld      de, #0xC000        ;;Puntero a la posición en pantalla (COOO sería el inicio de la pantalla)
   9E24 4F            [ 4]  178     ld      c,  a              ;;Coordenada X 
   9E25 06 89         [ 7]  179     ld      b,  #0x89         ;;Coordenada Y 
   9E27 CD 6C B0      [17]  180     call cpct_getScreenPtr_asm  ;;Función que calcula la dirección de memoria de video con esos parámetros
                            181 
   9E2A EB            [ 4]  182     ex      de, hl             ;;Intercambia los 2 valores (supongo que la fucion de dibujo lo usará)
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (Zilog Z80 / Hitachi HD64180), page 58.
Hexadecimal [16-Bits]



   9E2B 3E 1F         [ 7]  183     ld      a,  #0x1F          ;;Color (en la posición de la entidad)
   9E2D 0E 01         [ 7]  184     ld      c,  #1        ;;Ancho (en la posición de la entidad)
   9E2F 06 01         [ 7]  185     ld      b,  #1         ;;Alto (en la posición de la entidad)
   9E31 CD C1 AF      [17]  186     call cpct_drawSolidBox_asm  ;;Función de dibujado de cpc
                            187 
                            188 
   9E34 3E 05         [ 7]  189 ld a, #0x05
   9E36 11 00 C0      [10]  190     ld      de, #0xC000        ;;Puntero a la posición en pantalla (COOO sería el inicio de la pantalla)
   9E39 4F            [ 4]  191     ld      c,  a              ;;Coordenada X 
   9E3A 06 8A         [ 7]  192     ld      b,  #0x8A         ;;Coordenada Y 
   9E3C CD 6C B0      [17]  193     call cpct_getScreenPtr_asm  ;;Función que calcula la dirección de memoria de video con esos parámetros
                            194 
   9E3F EB            [ 4]  195     ex      de, hl             ;;Intercambia los 2 valores (supongo que la fucion de dibujo lo usará)
   9E40 3E 1F         [ 7]  196     ld      a,  #0x1F          ;;Color (en la posición de la entidad)
   9E42 0E 01         [ 7]  197     ld      c,  #1        ;;Ancho (en la posición de la entidad)
   9E44 06 01         [ 7]  198     ld      b,  #1         ;;Alto (en la posición de la entidad)
   9E46 CD C1 AF      [17]  199     call cpct_drawSolidBox_asm  ;;Función de dibujado de cpc
                            200 
                            201 
   9E49 3E 05         [ 7]  202 ld a, #0x05
   9E4B 11 00 C0      [10]  203     ld      de, #0xC000        ;;Puntero a la posición en pantalla (COOO sería el inicio de la pantalla)
   9E4E 4F            [ 4]  204     ld      c,  a              ;;Coordenada X 
   9E4F 06 8B         [ 7]  205     ld      b,  #0x8B         ;;Coordenada Y 
   9E51 CD 6C B0      [17]  206     call cpct_getScreenPtr_asm  ;;Función que calcula la dirección de memoria de video con esos parámetros
                            207 
   9E54 EB            [ 4]  208     ex      de, hl             ;;Intercambia los 2 valores (supongo que la fucion de dibujo lo usará)
   9E55 3E 1F         [ 7]  209     ld      a,  #0x1F          ;;Color (en la posición de la entidad)
   9E57 0E 01         [ 7]  210     ld      c,  #1        ;;Ancho (en la posición de la entidad)
   9E59 06 01         [ 7]  211     ld      b,  #1         ;;Alto (en la posición de la entidad)
   9E5B CD C1 AF      [17]  212     call cpct_drawSolidBox_asm  ;;Función de dibujado de cpc
                            213 
                            214 
   9E5E 3E 05         [ 7]  215 ld a, #0x05
   9E60 11 00 C0      [10]  216     ld      de, #0xC000        ;;Puntero a la posición en pantalla (COOO sería el inicio de la pantalla)
   9E63 4F            [ 4]  217     ld      c,  a              ;;Coordenada X 
   9E64 06 8C         [ 7]  218     ld      b,  #0x8C         ;;Coordenada Y 
   9E66 CD 6C B0      [17]  219     call cpct_getScreenPtr_asm  ;;Función que calcula la dirección de memoria de video con esos parámetros
                            220 
   9E69 EB            [ 4]  221     ex      de, hl             ;;Intercambia los 2 valores (supongo que la fucion de dibujo lo usará)
   9E6A 3E 1F         [ 7]  222     ld      a,  #0x1F          ;;Color (en la posición de la entidad)
   9E6C 0E 01         [ 7]  223     ld      c,  #1        ;;Ancho (en la posición de la entidad)
   9E6E 06 01         [ 7]  224     ld      b,  #1         ;;Alto (en la posición de la entidad)
   9E70 CD C1 AF      [17]  225     call cpct_drawSolidBox_asm  ;;Función de dibujado de cpc
                            226 
                            227 
   9E73 3E 05         [ 7]  228 ld a, #0x05
   9E75 11 00 C0      [10]  229     ld      de, #0xC000        ;;Puntero a la posición en pantalla (COOO sería el inicio de la pantalla)
   9E78 4F            [ 4]  230     ld      c,  a              ;;Coordenada X 
   9E79 06 8D         [ 7]  231     ld      b,  #0x8D         ;;Coordenada Y 
   9E7B CD 6C B0      [17]  232     call cpct_getScreenPtr_asm  ;;Función que calcula la dirección de memoria de video con esos parámetros
                            233 
   9E7E EB            [ 4]  234     ex      de, hl             ;;Intercambia los 2 valores (supongo que la fucion de dibujo lo usará)
   9E7F 3E 1F         [ 7]  235     ld      a,  #0x1F          ;;Color (en la posición de la entidad)
   9E81 0E 01         [ 7]  236     ld      c,  #1        ;;Ancho (en la posición de la entidad)
   9E83 06 01         [ 7]  237     ld      b,  #1         ;;Alto (en la posición de la entidad)
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (Zilog Z80 / Hitachi HD64180), page 59.
Hexadecimal [16-Bits]



   9E85 CD C1 AF      [17]  238     call cpct_drawSolidBox_asm  ;;Función de dibujado de cpc
                            239 
                            240 
   9E88 3E 05         [ 7]  241 ld a, #0x05
   9E8A 11 00 C0      [10]  242     ld      de, #0xC000        ;;Puntero a la posición en pantalla (COOO sería el inicio de la pantalla)
   9E8D 4F            [ 4]  243     ld      c,  a              ;;Coordenada X 
   9E8E 06 8E         [ 7]  244     ld      b,  #0x8E         ;;Coordenada Y 
   9E90 CD 6C B0      [17]  245     call cpct_getScreenPtr_asm  ;;Función que calcula la dirección de memoria de video con esos parámetros
                            246 
   9E93 EB            [ 4]  247     ex      de, hl             ;;Intercambia los 2 valores (supongo que la fucion de dibujo lo usará)
   9E94 3E 3F         [ 7]  248     ld      a,  #0x3F          ;;Color (en la posición de la entidad)
   9E96 0E 01         [ 7]  249     ld      c,  #1        ;;Ancho (en la posición de la entidad)
   9E98 06 01         [ 7]  250     ld      b,  #1         ;;Alto (en la posición de la entidad)
   9E9A CD C1 AF      [17]  251     call cpct_drawSolidBox_asm  ;;Función de dibujado de cpc
                            252 
                            253 
   9E9D 3E 05         [ 7]  254 ld a, #0x05
   9E9F 11 00 C0      [10]  255     ld      de, #0xC000        ;;Puntero a la posición en pantalla (COOO sería el inicio de la pantalla)
   9EA2 4F            [ 4]  256     ld      c,  a              ;;Coordenada X 
   9EA3 06 8F         [ 7]  257     ld      b,  #0x8F         ;;Coordenada Y 
   9EA5 CD 6C B0      [17]  258     call cpct_getScreenPtr_asm  ;;Función que calcula la dirección de memoria de video con esos parámetros
                            259 
   9EA8 EB            [ 4]  260     ex      de, hl             ;;Intercambia los 2 valores (supongo que la fucion de dibujo lo usará)
   9EA9 3E EE         [ 7]  261     ld      a,  #0xEE          ;;Color (en la posición de la entidad)
   9EAB 0E 01         [ 7]  262     ld      c,  #1        ;;Ancho (en la posición de la entidad)
   9EAD 06 01         [ 7]  263     ld      b,  #1         ;;Alto (en la posición de la entidad)
   9EAF CD C1 AF      [17]  264     call cpct_drawSolidBox_asm  ;;Función de dibujado de cpc
                            265 
                            266 ;;DERECHA
                            267 
   9EB2 3E 4A         [ 7]  268 ld a, #0x4A
   9EB4 11 00 C0      [10]  269     ld      de, #0xC000        ;;Puntero a la posición en pantalla (COOO sería el inicio de la pantalla)
   9EB7 4F            [ 4]  270     ld      c,  a              ;;Coordenada X 
   9EB8 06 50         [ 7]  271     ld      b,  #0x50         ;;Coordenada Y 
   9EBA CD 6C B0      [17]  272     call cpct_getScreenPtr_asm  ;;Función que calcula la dirección de memoria de video con esos parámetros
                            273 
   9EBD EB            [ 4]  274     ex      de, hl             ;;Intercambia los 2 valores (supongo que la fucion de dibujo lo usará)
   9EBE 3E 0F         [ 7]  275     ld      a,  #0x0F          ;;Color (en la posición de la entidad)
   9EC0 0E 02         [ 7]  276     ld      c,  #2        ;;Ancho (en la posición de la entidad)
   9EC2 06 40         [ 7]  277     ld      b,  #64         ;;Alto (en la posición de la entidad)
   9EC4 CD C1 AF      [17]  278     call cpct_drawSolidBox_asm  ;;Función de dibujado de cpc
                            279 
   9EC7 3E 4C         [ 7]  280     ld a, #0x4C
   9EC9 11 00 C0      [10]  281     ld      de, #0xC000        ;;Puntero a la posición en pantalla (COOO sería el inicio de la pantalla)
   9ECC 4F            [ 4]  282     ld      c,  a              ;;Coordenada X 
   9ECD 06 50         [ 7]  283     ld      b,  #0x50         ;;Coordenada Y 
   9ECF CD 6C B0      [17]  284     call cpct_getScreenPtr_asm  ;;Función que calcula la dirección de memoria de video con esos parámetros
                            285 
   9ED2 EB            [ 4]  286     ex      de, hl             ;;Intercambia los 2 valores (supongo que la fucion de dibujo lo usará)
   9ED3 3E 0F         [ 7]  287     ld      a,  #0x0F          ;;Color (en la posición de la entidad)
   9ED5 0E 04         [ 7]  288     ld      c,  #4        ;;Ancho (en la posición de la entidad)
   9ED7 06 06         [ 7]  289     ld      b,  #6         ;;Alto (en la posición de la entidad)
   9ED9 CD C1 AF      [17]  290     call cpct_drawSolidBox_asm  ;;Función de dibujado de cpc
                            291 
                            292 
...
Hexadecimal [16-Bits]
                            ...
                            293 ;;AQUI DIBUJAMOS LAS OLAS
                            294 
                            295 ;;AQUI LA LINEA DE ABAJO DE LAS OLAS QUE HAY QUE HACER 2 PORQUE CON 1 NO LLEGAMOS HASTA EL FINAL-----
   9EDC 3E 01         [ 7]  296 ld a, #0x01
                            297 
   9EDE 11 00 C0      [10]  298     ld      de, #0xC000        ;;Puntero a la posición en pantalla (COOO sería el inicio de la pantalla)
   9EE1 4F            [ 4]  299     ld      c,  a              ;;Coordenada X 
   9EE2 06 9E         [ 7]  300     ld      b,  #0x9E         ;;Coordenada Y 
   9EE4 CD 6C B0      [17]  301     call cpct_getScreenPtr_asm  ;;Función que calcula la dirección de memoria de video con esos parámetros
                            302 
   9EE7 EB            [ 4]  303     ex      de, hl             ;;Intercambia los 2 valores (supongo que la fucion de dibujo lo usará)
   9EE8 3E 0F         [ 7]  304     ld      a,  #0x0F          ;;Color (en la posición de la entidad)
   9EEA 0E 40         [ 7]  305     ld      c,  #64        ;;Ancho (en la posición de la entidad)
   9EEC 06 01         [ 7]  306     ld      b,  #1         ;;Alto (en la posición de la entidad)
   9EEE CD C1 AF      [17]  307     call cpct_drawSolidBox_asm  ;;Función de dibujado de cpc
                            308 
                            309 ;; SEGUNDA LINEA MAS CORTA
   9EF1 3E 40         [ 7]  310     ld a, #0x40
   9EF3 11 00 C0      [10]  311     ld      de, #0xC000        ;;Puntero a la posición en pantalla (COOO sería el inicio de la pantalla)
   9EF6 4F            [ 4]  312     ld      c,  a              ;;Coordenada X 
   9EF7 06 9E         [ 7]  313     ld      b,  #0x9E         ;;Coordenada Y 
   9EF9 CD 6C B0      [17]  314     call cpct_getScreenPtr_asm  ;;Función que calcula la dirección de memoria de video con esos parámetros
                            315 
   9EFC EB            [ 4]  316     ex      de, hl             ;;Intercambia los 2 valores (supongo que la fucion de dibujo lo usará)
   9EFD 3E 0F         [ 7]  317     ld      a,  #0x0F          ;;Color (en la posición de la entidad)
   9EFF 0E 0A         [ 7]  318     ld      c,  #10        ;;Ancho (en la posición de la entidad)
   9F01 06 01         [ 7]  319     ld      b,  #1         ;;Alto (en la posición de la entidad)
   9F03 CD C1 AF      [17]  320     call cpct_drawSolidBox_asm  ;;Función de dibujado de cpc
                            321 
                            322 ;;EMPIEZAN LAS OLAS
   9F06                     323 olas::
   9F06 3E 4B         [ 7]  324     ld a, #0x4B
   9F08                     325 olas1:
   9F08 F5            [11]  326     push af
                            327     
   9F09 11 00 C0      [10]  328     ld      de, #0xC000        ;;Puntero a la posición en pantalla (COOO sería el inicio de la pantalla)
   9F0C 4F            [ 4]  329     ld      c,  a              ;;Coordenada X 
   9F0D 06 94         [ 7]  330     ld      b,  #0x94         ;;Coordenada Y 
   9F0F CD 6C B0      [17]  331     call cpct_getScreenPtr_asm  ;;Función que calcula la dirección de memoria de video con esos parámetros
                            332 
   9F12 EB            [ 4]  333     ex      de, hl             ;;Intercambia los 2 valores (supongo que la fucion de dibujo lo usará)
   9F13 3E 0E         [ 7]  334     ld      a,  #0x0E          ;;Color (en la posición de la entidad)
   9F15 0E 01         [ 7]  335     ld      c,  #1        ;;Ancho (en la posición de la entidad)
   9F17 06 04         [ 7]  336     ld      b,  #4         ;;Alto (en la posición de la entidad)
   9F19 CD C1 AF      [17]  337     call cpct_drawSolidBox_asm  ;;Función de dibujado de cpc
                            338 
   9F1C F1            [10]  339     pop af
   9F1D 3D            [ 4]  340     dec a
   9F1E 28 11         [12]  341     jr z, final
   9F20 3D            [ 4]  342     dec a
   9F21 28 0E         [12]  343     jr z, final
   9F23 3D            [ 4]  344     dec a
   9F24 28 0B         [12]  345     jr z, final
   9F26 3D            [ 4]  346     dec a
   9F27 28 08         [12]  347     jr z, final
...
Hexadecimal [16-Bits]
   ...
   9F29 3D            [ 4]  348     dec a
   9F2A 28 05         [12]  349     jr z, final
   9F2C 3D            [ 4]  350     dec a
   9F2D 28 02         [12]  351     jr z, final
   9F2F 20 D7         [12]  352     jr nz, olas1
   9F31                     353 final:
                            354 
   9F31 3E 4A         [ 7]  355 ld a, #0x4A
   9F33                     356 olas2:
   9F33 F5            [11]  357     push af
                            358     
   9F34 11 00 C0      [10]  359     ld      de, #0xC000        ;;Puntero a la posición en pantalla (COOO sería el inicio de la pantalla)
   9F37 4F            [ 4]  360     ld      c,  a              ;;Coordenada X 
   9F38 06 95         [ 7]  361     ld      b,  #0x95         ;;Coordenada Y 
   9F3A CD 6C B0      [17]  362     call cpct_getScreenPtr_asm  ;;Función que calcula la dirección de memoria de video con esos parámetros
                            363 
   9F3D EB            [ 4]  364     ex      de, hl             ;;Intercambia los 2 valores (supongo que la fucion de dibujo lo usará)
   9F3E 3E 0E         [ 7]  365     ld      a,  #0x0E          ;;Color (en la posición de la entidad)
   9F40 0E 01         [ 7]  366     ld      c,  #1        ;;Ancho (en la posición de la entidad)
   9F42 06 04         [ 7]  367     ld      b,  #4         ;;Alto (en la posición de la entidad)
   9F44 CD C1 AF      [17]  368     call cpct_drawSolidBox_asm  ;;Función de dibujado de cpc
                            369 
   9F47 F1            [10]  370     pop af
   9F48 3D            [ 4]  371     dec a
   9F49 28 11         [12]  372     jr z, final2
   9F4B 3D            [ 4]  373     dec a
   9F4C 28 0E         [12]  374     jr z, final2
   9F4E 3D            [ 4]  375     dec a
   9F4F 28 0B         [12]  376     jr z, final2
   9F51 3D            [ 4]  377     dec a
   9F52 28 08         [12]  378     jr z, final2
   9F54 3D            [ 4]  379     dec a
   9F55 28 05         [12]  380     jr z, final2
   9F57 3D            [ 4]  381     dec a
   9F58 28 02         [12]  382     jr z, final2
   9F5A 20 D7         [12]  383     jr nz, olas2
   9F5C                     384 final2:
                            385 
   9F5C 3E 49         [ 7]  386 ld a, #0x49
   9F5E                     387 olas3:
   9F5E F5            [11]  388     push af
                            389     
   9F5F 11 00 C0      [10]  390     ld      de, #0xC000        ;;Puntero a la posición en pantalla (COOO sería el inicio de la pantalla)
   9F62 4F            [ 4]  391     ld      c,  a              ;;Coordenada X 
   9F63 06 96         [ 7]  392     ld      b,  #0x96         ;;Coordenada Y 
   9F65 CD 6C B0      [17]  393     call cpct_getScreenPtr_asm  ;;Función que calcula la dirección de memoria de video con esos parámetros
                            394 
   9F68 EB            [ 4]  395     ex      de, hl             ;;Intercambia los 2 valores (supongo que la fucion de dibujo lo usará)
   9F69 3E 0E         [ 7]  396     ld      a,  #0x0E          ;;Color (en la posición de la entidad)
   9F6B 0E 01         [ 7]  397     ld      c,  #1        ;;Ancho (en la posición de la entidad)
   9F6D 06 04         [ 7]  398     ld      b,  #4         ;;Alto (en la posición de la entidad)
   9F6F CD C1 AF      [17]  399     call cpct_drawSolidBox_asm  ;;Función de dibujado de cpc
                            400 
   9F72 F1            [10]  401     pop af
   9F73 3D            [ 4]  402     dec a
...
Hexadecimal [16-Bits]
   ...
   9F74 28 11         [12]  403     jr z, final3
   9F76 3D            [ 4]  404     dec a
   9F77 28 0E         [12]  405     jr z, final3
   9F79 3D            [ 4]  406     dec a
   9F7A 28 0B         [12]  407     jr z, final3
   9F7C 3D            [ 4]  408      dec a
   9F7D 28 08         [12]  409     jr z, final3
   9F7F 3D            [ 4]  410     dec a
   9F80 28 05         [12]  411     jr z, final3
   9F82 3D            [ 4]  412     dec a
   9F83 28 02         [12]  413     jr z, final3
   9F85 20 D7         [12]  414     jr nz, olas3
   9F87                     415 final3:
                            416 
   9F87 3E 48         [ 7]  417 ld a, #0x48
   9F89                     418 olas4:
   9F89 F5            [11]  419     push af
                            420     
   9F8A 11 00 C0      [10]  421     ld      de, #0xC000        ;;Puntero a la posición en pantalla (COOO sería el inicio de la pantalla)
   9F8D 4F            [ 4]  422     ld      c,  a              ;;Coordenada X 
   9F8E 06 97         [ 7]  423     ld      b,  #0x97         ;;Coordenada Y 
   9F90 CD 6C B0      [17]  424     call cpct_getScreenPtr_asm  ;;Función que calcula la dirección de memoria de video con esos parámetros
                            425 
   9F93 EB            [ 4]  426     ex      de, hl             ;;Intercambia los 2 valores (supongo que la fucion de dibujo lo usará)
   9F94 3E 0E         [ 7]  427     ld      a,  #0x0E          ;;Color (en la posición de la entidad)
   9F96 0E 01         [ 7]  428     ld      c,  #1        ;;Ancho (en la posición de la entidad)
   9F98 06 04         [ 7]  429     ld      b,  #4         ;;Alto (en la posición de la entidad)
   9F9A CD C1 AF      [17]  430     call cpct_drawSolidBox_asm  ;;Función de dibujado de cpc
                            431 
   9F9D F1            [10]  432     pop af
   9F9E 3D            [ 4]  433     dec a
   9F9F 28 11         [12]  434     jr z, final4
   9FA1 3D            [ 4]  435     dec a
   9FA2 28 0E         [12]  436     jr z, final4
   9FA4 3D            [ 4]  437     dec a
   9FA5 28 0B         [12]  438     jr z, final4
   9FA7 3D            [ 4]  439     dec a
   9FA8 28 08         [12]  440     jr z, final4
   9FAA 3D            [ 4]  441     dec a
   9FAB 28 05         [12]  442     jr z, final4
   9FAD 3D            [ 4]  443     dec a
   9FAE 28 02         [12]  444     jr z, final4
   9FB0 20 D7         [12]  445     jr nz, olas4
   9FB2                     446 final4:
                            447 
                            448 
                            449 
                            450 ;;AQUI EMPIEZA LAS OLAS EN LA OTRA DIRECCION
   9FB2 3E 4C         [ 7]  451 ld a, #0x4C
   9FB4                     452 olas7:
   9FB4 F5            [11]  453     push af
                            454     
   9FB5 11 00 C0      [10]  455     ld      de, #0xC000        ;;Puntero a la posición en pantalla (COOO sería el inicio de la pantalla)
   9FB8 4F            [ 4]  456     ld      c,  a              ;;Coordenada X 
   9FB9 06 94         [ 7]  457     ld      b,  #0x94         ;;Coordenada Y 
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (Zilog Z80 / Hitachi HD64180), page 63.
Hexadecimal [16-Bits]



   9FBB CD 6C B0      [17]  458     call cpct_getScreenPtr_asm  ;;Función que calcula la dirección de memoria de video con esos parámetros
                            459 
   9FBE EB            [ 4]  460     ex      de, hl             ;;Intercambia los 2 valores (supongo que la fucion de dibujo lo usará)
   9FBF 3E 0E         [ 7]  461     ld      a,  #0x0E          ;;Color (en la posición de la entidad)
   9FC1 0E 01         [ 7]  462     ld      c,  #1        ;;Ancho (en la posición de la entidad)
   9FC3 06 04         [ 7]  463     ld      b,  #4         ;;Alto (en la posición de la entidad)
   9FC5 CD C1 AF      [17]  464     call cpct_drawSolidBox_asm  ;;Función de dibujado de cpc
                            465 
   9FC8 F1            [10]  466     pop af
   9FC9 3D            [ 4]  467     dec a
   9FCA 28 11         [12]  468     jr z, final7
   9FCC 3D            [ 4]  469     dec a
   9FCD 28 0E         [12]  470     jr z, final7
   9FCF 3D            [ 4]  471     dec a
   9FD0 28 0B         [12]  472     jr z, final7
   9FD2 3D            [ 4]  473     dec a
   9FD3 28 08         [12]  474     jr z, final7
   9FD5 3D            [ 4]  475     dec a
   9FD6 28 05         [12]  476     jr z, final7
   9FD8 3D            [ 4]  477     dec a
   9FD9 28 02         [12]  478     jr z, final7
   9FDB 20 D7         [12]  479     jr nz, olas7
   9FDD                     480 final7:
                            481 
   9FDD 3E 4D         [ 7]  482 ld a, #0x4D
   9FDF                     483 olas8:
   9FDF F5            [11]  484     push af
                            485     
   9FE0 11 00 C0      [10]  486     ld      de, #0xC000        ;;Puntero a la posición en pantalla (COOO sería el inicio de la pantalla)
   9FE3 4F            [ 4]  487     ld      c,  a              ;;Coordenada X 
   9FE4 06 95         [ 7]  488     ld      b,  #0x95         ;;Coordenada Y 
   9FE6 CD 6C B0      [17]  489     call cpct_getScreenPtr_asm  ;;Función que calcula la dirección de memoria de video con esos parámetros
                            490 
   9FE9 EB            [ 4]  491     ex      de, hl             ;;Intercambia los 2 valores (supongo que la fucion de dibujo lo usará)
   9FEA 3E 0E         [ 7]  492     ld      a,  #0x0E          ;;Color (en la posición de la entidad)
   9FEC 0E 01         [ 7]  493     ld      c,  #1        ;;Ancho (en la posición de la entidad)
   9FEE 06 04         [ 7]  494     ld      b,  #4         ;;Alto (en la posición de la entidad)
   9FF0 CD C1 AF      [17]  495     call cpct_drawSolidBox_asm  ;;Función de dibujado de cpc
                            496 
   9FF3 F1            [10]  497     pop af
   9FF4 3D            [ 4]  498     dec a
   9FF5 28 11         [12]  499     jr z, final8
   9FF7 3D            [ 4]  500     dec a
   9FF8 28 0E         [12]  501     jr z, final8
   9FFA 3D            [ 4]  502     dec a
   9FFB 28 0B         [12]  503     jr z, final8
   9FFD 3D            [ 4]  504     dec a
   9FFE 28 08         [12]  505     jr z, final8
   A000 3D            [ 4]  506     dec a
   A001 28 05         [12]  507     jr z, final8
   A003 3D            [ 4]  508     dec a
   A004 28 02         [12]  509     jr z, final8
   A006 20 D7         [12]  510     jr nz, olas8
   A008                     511 final8:
                            512 
...
Hexadecimal [16-Bits]
   ...
   A008 3E 4E         [ 7]  513 ld a, #0x4E
   A00A                     514 olas9:
   A00A F5            [11]  515     push af
                            516     
   A00B 11 00 C0      [10]  517     ld      de, #0xC000        ;;Puntero a la posición en pantalla (COOO sería el inicio de la pantalla)
   A00E 4F            [ 4]  518     ld      c,  a              ;;Coordenada X 
   A00F 06 96         [ 7]  519     ld      b,  #0x96         ;;Coordenada Y 
   A011 CD 6C B0      [17]  520     call cpct_getScreenPtr_asm  ;;Función que calcula la dirección de memoria de video con esos parámetros
                            521 
   A014 EB            [ 4]  522     ex      de, hl             ;;Intercambia los 2 valores (supongo que la fucion de dibujo lo usará)
   A015 3E 0E         [ 7]  523     ld      a,  #0x0E          ;;Color (en la posición de la entidad)
   A017 0E 01         [ 7]  524     ld      c,  #1        ;;Ancho (en la posición de la entidad)
   A019 06 04         [ 7]  525     ld      b,  #4         ;;Alto (en la posición de la entidad)
   A01B CD C1 AF      [17]  526     call cpct_drawSolidBox_asm  ;;Función de dibujado de cpc
                            527 
   A01E F1            [10]  528     pop af
   A01F 3D            [ 4]  529     dec a
   A020 28 11         [12]  530     jr z, final9
   A022 3D            [ 4]  531     dec a
   A023 28 0E         [12]  532     jr z, final9
   A025 3D            [ 4]  533     dec a
   A026 28 0B         [12]  534     jr z, final9
   A028 3D            [ 4]  535      dec a
   A029 28 08         [12]  536     jr z, final9
   A02B 3D            [ 4]  537     dec a
   A02C 28 05         [12]  538     jr z, final9
   A02E 3D            [ 4]  539     dec a
   A02F 28 02         [12]  540     jr z, final9
   A031 20 D7         [12]  541     jr nz, olas9
   A033                     542 final9:
                            543 
   A033 3E 4F         [ 7]  544 ld a, #0x4F
   A035                     545 olas10:
   A035 F5            [11]  546     push af
                            547     
   A036 11 00 C0      [10]  548     ld      de, #0xC000        ;;Puntero a la posición en pantalla (COOO sería el inicio de la pantalla)
   A039 4F            [ 4]  549     ld      c,  a              ;;Coordenada X 
   A03A 06 97         [ 7]  550     ld      b,  #0x97         ;;Coordenada Y 
   A03C CD 6C B0      [17]  551     call cpct_getScreenPtr_asm  ;;Función que calcula la dirección de memoria de video con esos parámetros
                            552 
   A03F EB            [ 4]  553     ex      de, hl             ;;Intercambia los 2 valores (supongo que la fucion de dibujo lo usará)
   A040 3E 0E         [ 7]  554     ld      a,  #0x0E          ;;Color (en la posición de la entidad)
   A042 0E 01         [ 7]  555     ld      c,  #1        ;;Ancho (en la posición de la entidad)
   A044 06 04         [ 7]  556     ld      b,  #4         ;;Alto (en la posición de la entidad)
   A046 CD C1 AF      [17]  557     call cpct_drawSolidBox_asm  ;;Función de dibujado de cpc
                            558 
   A049 F1            [10]  559     pop af
   A04A 3D            [ 4]  560     dec a
   A04B 28 11         [12]  561     jr z, final10
   A04D 3D            [ 4]  562     dec a
   A04E 28 0E         [12]  563     jr z, final10
   A050 3D            [ 4]  564     dec a
   A051 28 0B         [12]  565     jr z, final10
   A053 3D            [ 4]  566     dec a
   A054 28 08         [12]  567     jr z, final10
...
Hexadecimal [16-Bits]
   ...
   A056 3D            [ 4]  568     dec a
   A057 28 05         [12]  569     jr z, final10
   A059 3D            [ 4]  570     dec a
   A05A 28 02         [12]  571     jr z, final10
   A05C 20 D7         [12]  572     jr nz, olas10
   A05E                     573 final10:
                            574 
                            575 ;;EMPIEZAN LAS OLAS DE DEBAJO
                            576  
                            577 
                            578 
   A05E C9            [10]  579 ret
                            ...
                            581 
                            582 
                            583 ;;BORRAR OLAS PARA REDIBUJARLAS
   A05F                     584 borrarOlas::
                            585 
   A05F 11 00 C0      [10]  586 ld      de, #0xC000        ;;Puntero a la posición en pantalla (COOO sería el inicio de la pantalla)
   A062 0E 00         [ 7]  587     ld      c,  #0x0              ;;Coordenada X 
   A064 06 92         [ 7]  588     ld      b,  #0x92        ;;Coordenada Y 
   A066 CD 6C B0      [17]  589     call cpct_getScreenPtr_asm  ;;Función que calcula la dirección de memoria de video con esos parámetros
                            590 
   A069 EB            [ 4]  591     ex      de, hl             ;;Intercambia los 2 valores (supongo que la fucion de dibujo lo usará)
   A06A 3E 00         [ 7]  592     ld      a,  #0x00         ;;Color (en la posición de la entidad)
   A06C 0E 3C         [ 7]  593     ld      c,  #60      ;;Ancho (en la posición de la entidad)
   A06E 06 09         [ 7]  594     ld      b,  #9        ;;Alto (en la posición de la entidad)
   A070 CD C1 AF      [17]  595     call cpct_drawSolidBox_asm  ;;Función de dibujado de cpc
                            596 
   A073 11 00 C0      [10]  597     ld      de, #0xC000        ;;Puntero a la posición en pantalla (COOO sería el inicio de la pantalla)
   A076 0E 3C         [ 7]  598     ld      c,  #60              ;;Coordenada X 
   A078 06 92         [ 7]  599     ld      b,  #0x92        ;;Coordenada Y 
   A07A CD 6C B0      [17]  600     call cpct_getScreenPtr_asm  ;;Función que calcula la dirección de memoria de video con esos parámetros
                            601 
   A07D EB            [ 4]  602     ex      de, hl             ;;Intercambia los 2 valores (supongo que la fucion de dibujo lo usará)
   A07E 3E 00         [ 7]  603     ld      a,  #0x00         ;;Color (en la posición de la entidad)
   A080 0E 14         [ 7]  604     ld      c,  #20      ;;Ancho (en la posición de la entidad)
   A082 06 09         [ 7]  605     ld      b,  #9        ;;Alto (en la posición de la entidad)
   A084 CD C1 AF      [17]  606     call cpct_drawSolidBox_asm  ;;Función de dibujado de cpc
                            607 
   A087 C9            [10]  608     ret
