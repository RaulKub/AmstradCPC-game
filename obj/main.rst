...
Hexadecimal [16-Bits]
                             ...
                             17 ;;-------------------------------------------------------------------------------
                     0010    18 max_entities == 16
                     0007    19 entity_size == 7
                             20 ;;
   4000 00                   21 _num_entities::     .db 0
   4001 03 40                22 _last_elem_ptr::    .dw _entity_array
   4003                      23 _entity_array::
   4003                      24 .ds max_entities*entity_size
                             25 ;; Include all CPCtelera constant definitions, macros and variables
                             26 ;;.include "manager/entity_manager.s"
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (Zilog Z80 / Hitachi HD64180), page 2.
Hexadecimal [16-Bits]



                             27 .include "manager/entity_manager.h.s"
...
Hexadecimal [16-Bits]
                             ...
                             30 .include "system/render_system.h.s"
                              1 ;;This file is part of Kubso.
                              2 ;;
                              3 ;;Kubso is free software: you can redistribute it and/or modify
                              4 ;;it under the terms of the GNU General Public License as published by
...
Hexadecimal [16-Bits]
                             ...
                             31 .include "system/mainJuego.h.s"
                              1 ;;This file is part of Kubso.
                              2 ;;
                              3 ;;Kubso is free software: you can redistribute it and/or modify
                              4 ;;it under the terms of the GNU General Public License as published by
...
Hexadecimal [16-Bits]
                             ...
                             42 
                             43 
                             44 ;; Define one Zero-terminated string to be used later on
                             45 
                             46 
                             47 ;;
                             ...
                             51 
                             52 ;; 
                             53 ;; Declare all function entry points as global symbols for the compiler.
                             54 ;; (The linker will know what to do with them)
                             55 ;; WARNING: Every global symbol declared will be linked, so DO NOT declare 
                             56 ;; symbols for functions you do not use.
                             57 ;;
                             58 
                             59 
                             60 ;;
                             61 ;; MAIN function. This is the entry point of the application.
                             62 ;;    _main:: global symbol is required for correctly compiling and linking
                             63 ;;
   4073 57 65 6C 63 6F 6D    64 title: .asciz "Welcome to ARCADE TUBE!!";
        65 20 74 6F 20 41
        52 43 41 44 45 20
        54 55 42 45 21 21
        00
   408C 0A 0A 0A 00          65 flechasabajo: .asciz "\n\n\n";
   4090 50 72 65 73 73 20    66 pulsaparacontinuar: .asciz "Press any key to continue";
        61 6E 79 20 6B 65
        79 20 74 6F 20 63
        6F 6E 74 69 6E 75
        65 00
                             ...
                             68 
                             69 
                             70 ;;player:  .db 20, 20, 2, 8, 1, 1, 0xFF
                             71 ;;enemy:  .db 40, 80, 2, 8, 1, 1, 0xF0
                             72 
   40AA                      73 _main::
                             74    ;; Disable firmware to prevent it from interfering with string drawing
   40AA CD B1 AF      [17]   75    call cpct_disableFirmware_asm
                             76 
                             77    ;;call entityman_init
                             78 
...
Hexadecimal [16-Bits]
                             ...
                             79    ;;Init systems
   40AD CD 88 A0      [17]   80    call  rendersys_init
                             81    
                             82 
                             83    ;;//////////PINTAMOS PRIMERA LINEA DEL TITULO//////////
                             84 
                             85    ;; Set up draw char colours before calling draw string
   40B0 16 00         [ 7]   86    ld    d, #0         ;; D = Background PEN (0)
   40B2 1E 01         [ 7]   87    ld    e, #1         ;; E = Foreground PEN (3) ;;3 rojo, 2 azul, 1 amarillo, 0 fondo, mas de 3 multicolor
                             88 
   40B4 CD 88 B0      [17]   89    call cpct_setDrawCharM1_asm   ;; Set draw char colours
                             90 
                             91    ;; Calculate a video-memory location for printing a string
   40B7 11 00 C0      [10]   92    ld   de, #CPCT_VMEM_START_ASM ;; DE = Pointer to start of the screen
   40BA 06 18         [ 7]   93    ld    b, #24                  ;; B = y coordinate (24 = 0x18)
   40BC 0E 12         [ 7]   94    ld    c, #18                  ;; C = x coordinate (16 = 0x10)
                             95 
   40BE CD 6C B0      [17]   96    call cpct_getScreenPtr_asm    ;; Calculate video memory location and return it in HL
                             97 
                             98    ;; Print the string in video memory
                             99    ;; HL already points to video memory, as it is the return
                            100    ;; value from cpct_getScreenPtr_asm
   40C1 FD 21 73 40   [14]  101    ld   iy, #title    ;; IY = Pointer to the string 
                            102    
   40C5 CD 63 AE      [17]  103    call cpct_drawStringM1_asm
                            104 
                            105    ;;////////Esperamos////////
   40C8 3E F4         [ 7]  106    ld a, #500
   40CA                     107    espera:
   40CA 76            [ 4]  108    halt
   40CB 3D            [ 4]  109    dec a
   40CC 20 FC         [12]  110    jr nz, espera
                            111 
                            112    ;;//////////PINTAMOS SEGUNDA LINEA DEL TITULO (flechas)//////////
   40CE 16 00         [ 7]  113    ld    d, #0 
   40D0 1E 01         [ 7]  114    ld    e, #1 
   40D2 CD 88 B0      [17]  115    call cpct_setDrawCharM1_asm
   40D5 11 00 C0      [10]  116    ld   de, #CPCT_VMEM_START_ASM 
   40D8 06 28         [ 7]  117    ld    b, #40    
   40DA 0E 25         [ 7]  118    ld    c, #0x25         
   40DC CD 6C B0      [17]  119    call cpct_getScreenPtr_asm 
   40DF FD 21 8C 40   [14]  120    ld   iy, #flechasabajo 
   40E3 CD 63 AE      [17]  121    call cpct_drawStringM1_asm 
                            122 
                            123 
                            124    ;;//////////PINTAMOS TERCERA LINEA DEL TITULO (pulsar tecla)//////////
   40E6                     125    teclanopulsada: ;;Bucle para repintar la linea para asi crear parpadeo
                            126 
                            127    ;;espera mientras detecta la tecla pulsada
   40E6 3E 64         [ 7]  128    ld a, #100
   40E8                     129    esperaVacio:
   40E8 F5            [11]  130    push af
   40E9 CD DA AD      [17]  131    call cpct_scanKeyboard_f_asm
   40EC CD 89 AF      [17]  132    call cpct_isAnyKeyPressed_f_asm
   40EF 3C            [ 4]  133    inc a
...
Hexadecimal [16-Bits]
   ...
   40F0 3D            [ 4]  134    dec a
   40F1 20 51         [12]  135    jr nz, detectadateclapulsada
   40F3 F1            [10]  136    pop af
   40F4 76            [ 4]  137    halt
   40F5 3D            [ 4]  138    dec a
   40F6 20 F0         [12]  139    jr nz, esperaVacio
                            140 
                            141    ;;Se pinta
   40F8 16 02         [ 7]  142    ld    d, #2 
   40FA 1E 03         [ 7]  143    ld    e, #3 
   40FC CD 88 B0      [17]  144    call cpct_setDrawCharM1_asm 
   40FF 11 00 C0      [10]  145    ld   de, #CPCT_VMEM_START_ASM 
   4102 06 38         [ 7]  146    ld    b, #56               
   4104 0E 10         [ 7]  147    ld    c, #0x10     
   4106 CD 6C B0      [17]  148    call cpct_getScreenPtr_asm 
   4109 FD 21 90 40   [14]  149    ld   iy, #pulsaparacontinuar 
   410D CD 63 AE      [17]  150    call cpct_drawStringM1_asm 
                            151 
                            152    ;;vuelta a esperar mientras se detecta la tecla pulsada
   4110 3E 64         [ 7]  153    ld a, #100
   4112                     154    esperaRelleno:
   4112 F5            [11]  155    push af
   4113 CD DA AD      [17]  156    call cpct_scanKeyboard_f_asm
   4116 CD 89 AF      [17]  157    call cpct_isAnyKeyPressed_f_asm
   4119 3C            [ 4]  158    inc a
   411A 3D            [ 4]  159    dec a
   411B 20 27         [12]  160    jr nz, detectadateclapulsada
   411D F1            [10]  161    pop af
   411E 76            [ 4]  162    halt
   411F 3D            [ 4]  163    dec a
   4120 20 F0         [12]  164    jr nz, esperaRelleno
                            165 
                            166    ;;Se borra el string pintado (repintando en color fondo) para el efecto de parapadeo
   4122 16 00         [ 7]  167    ld    d, #0  
   4124 1E 00         [ 7]  168    ld    e, #0  
   4126 CD 88 B0      [17]  169    call cpct_setDrawCharM1_asm 
   4129 11 00 C0      [10]  170    ld   de, #CPCT_VMEM_START_ASM 
   412C 06 38         [ 7]  171    ld    b, #56         
   412E 0E 10         [ 7]  172    ld    c, #0x10     
   4130 CD 6C B0      [17]  173    call cpct_getScreenPtr_asm
   4133 FD 21 90 40   [14]  174    ld   iy, #pulsaparacontinuar 
   4137 CD 63 AE      [17]  175    call cpct_drawStringM1_asm
                            176 
                            177    ;;//////////BUCLE HASTA QUE UNA TECLA SE PULSE//////////
                            178    
   413A CD DA AD      [17]  179    call cpct_scanKeyboard_f_asm
   413D CD 89 AF      [17]  180    call cpct_isAnyKeyPressed_f_asm
   4140 3C            [ 4]  181    inc a
   4141 3D            [ 4]  182    dec a
   4142 28 A2         [12]  183    jr z, teclanopulsada
                            184 
                            185 
   4144                     186 detectadateclapulsada:
                            187 
   4144 CD 81 AF      [17]  188    call cpct_waitVSYNC_asm
...
Hexadecimal [16-Bits]
   ...
   4148 76            [ 4]  190    halt
                            191 
                            192    ;;Primero borramos las letras del titulo (reescribiendolas con color fondo)
                            193    ;;Primera linea
   4149 16 00         [ 7]  194    ld    d, #0 
   414B 1E 00         [ 7]  195    ld    e, #0  
   414D CD 88 B0      [17]  196    call cpct_setDrawCharM1_asm 
   4150 11 00 C0      [10]  197    ld   de, #CPCT_VMEM_START_ASM 
   4153 06 18         [ 7]  198    ld    b, #24    
   4155 0E 12         [ 7]  199    ld    c, #18   
   4157 CD 6C B0      [17]  200    call cpct_getScreenPtr_asm
   415A FD 21 73 40   [14]  201    ld   iy, #title 
   415E CD 63 AE      [17]  202    call cpct_drawStringM1_asm
                            203    
                            204    ;; Segunda linea
   4161 16 00         [ 7]  205    ld    d, #0 
   4163 1E 00         [ 7]  206    ld    e, #0  
   4165 CD 88 B0      [17]  207    call cpct_setDrawCharM1_asm   
   4168 11 00 C0      [10]  208    ld   de, #CPCT_VMEM_START_ASM 
   416B 06 28         [ 7]  209    ld    b, #40          
   416D 0E 25         [ 7]  210    ld    c, #0x25     
   416F CD 6C B0      [17]  211    call cpct_getScreenPtr_asm    
   4172 FD 21 8C 40   [14]  212    ld   iy, #flechasabajo 
   4176 CD 63 AE      [17]  213    call cpct_drawStringM1_asm  
                            214 
                            215    ;; Tercera linea
   4179 16 00         [ 7]  216    ld    d, #0    
   417B 1E 00         [ 7]  217    ld    e, #0  
   417D CD 88 B0      [17]  218    call cpct_setDrawCharM1_asm 
   4180 11 00 C0      [10]  219    ld   de, #CPCT_VMEM_START_ASM 
   4183 06 38         [ 7]  220    ld    b, #56   
   4185 0E 10         [ 7]  221    ld    c, #0x10  
   4187 CD 6C B0      [17]  222    call cpct_getScreenPtr_asm  
   418A FD 21 90 40   [14]  223    ld   iy, #pulsaparacontinuar 
   418E CD 63 AE      [17]  224    call cpct_drawStringM1_asm  
                            225 
                            226 
   4191 CD 82 8F      [17]  227    call GameStart
                            228 
                            229    
                            230 
                            231    ;; Loop forever
   4194                     232 loop:
   4194 18 FE         [12]  233    jr    loop
